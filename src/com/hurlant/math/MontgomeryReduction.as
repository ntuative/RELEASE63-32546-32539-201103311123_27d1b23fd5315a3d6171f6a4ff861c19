package com.hurlant.math
{
   ...
   class MontgomeryReduction implements IReduction
   {
      ...
      function MontgomeryReduction(param1:BigInteger)
      {
         super();
         this.m = param1;
         this.var_2016 = param1.invDigit();
         this.var_2015 = this.var_2016 & 32767;
         this.var_2808 = this.var_2016 >> 15;
         this.var_2809 = 131071;
         this.var_2807 = 2 * param1.t;
      }
      ...
      public function convert(param1:BigInteger) : BigInteger
      {
         ...
         if(param1.s < 0 && _loc2_.compareTo(BigInteger.const_164) > 0)
         {
