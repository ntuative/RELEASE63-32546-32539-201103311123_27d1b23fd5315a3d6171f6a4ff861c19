package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_963:uint = 11;
      ...
      private var var_47:IRoomWidgetFactory;
      ...
      private var var_201:IHabboFriendList;
      
      private var var_1123:IHabboWindowManager;
      
      private var var_181:IHabboToolbar;
      
      private var var_129:IHabboHelp;
      ...
      private var var_596:LagWarningLogger = null;
      
      private var var_595:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_596 = new LagWarningLogger();
         this.var_595 = new ToolbarClickTracker(this);
         this.var_1390 = new Array(const_963);
         var _loc4_:int = 0;
         while(_loc4_ < const_963)
         {
            this.var_1390[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1644,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1628,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1710,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_806,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1258,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1123)
            {
               this.var_1123.release(new IIDHabboWindowManager());
               this.var_1123 = null;
            }
            if(this.var_311)
            {
            ...
            if(this.var_47)
            {
               this.var_47.release(new IIDHabboRoomWidget());
               this.var_47 = null;
            }
            if(this._navigator)
            {
            ...
            if(this.var_201)
            {
               ...
               {
                  Component(this.var_201).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
                  Component(this.var_201).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
                  Component(this.var_201).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
                  Component(this.var_201).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
                  Component(this.var_201).events.removeEventListener(HabboFriendListTrackingEvent.const_353,this.onFriendlistTrackingEvent);
               }
               this.var_201.release(new IIDHabboFriendList());
               this.var_201 = null;
            }
            if(this.var_129)
            {
               if(!this.var_129.disposed)
               {
                  this.var_129.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_129.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_129.release(new IIDHabboHelp());
               this.var_129 = null;
            }
            if(this.var_181)
            {
               ...
               {
                  this.var_181.events.removeEventListener(HabboToolbarEvent.const_39,this.onToolbarClick);
               }
            ...
            if(this._roomEngine)
            {
               if(!this._roomEngine.disposed)
               {
                  ...
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_295,this.onRoomAction);
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_300,this.onRoomAction);
               }
            ...
            {
               this.var_304.stop();
               this.var_304.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
               this.var_304 = null;
            }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_184)
         {
            if(this.var_247 != null)
            {
               this.var_247.configuration = this.var_184;
            }
            if(this.var_246 != null)
            {
               this.var_246.configuration = this.var_184;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1667);
            if(this.var_184)
            {
               if(this.var_596 != null)
               {
                  this.var_596.configure(this.var_184);
               }
               if(this.var_431 != null)
               {
                  this.var_431.configure(this.var_184);
               }
               if(this.var_595 != null)
               {
                  this.var_595.configure(this.var_184);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_259,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_177,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_175,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_256,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_943,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_65,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_502,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_596 != null)
            {
               this.var_596.connection = param1;
            }
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1662);
               break;
            case HabboCommunicationEvent.const_794:
               this.trackLoginStep(HabboLoginTrackingStep.const_1536,String(this._communication.port));
               break;
            case HabboCommunicationEvent.const_259:
               this.trackLoginStep(HabboLoginTrackingStep.const_259);
               break;
      ...
      {
         this.var_1123 = IHabboWindowManager(param2);
         if(this.var_1123)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_184)
            {
               if(this.var_184.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1390)
                  {
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1135);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1135,this.onCoreRunning);
         }
      }
      ...
      {
         this.var_201 = param2 as IHabboFriendList;
         Component(this.var_201).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
         Component(this.var_201).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
         Component(this.var_201).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
         Component(this.var_201).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
         Component(this.var_201).events.addEventListener(HabboFriendListTrackingEvent.const_353,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_353:
      ...
      {
         this.var_47 = param2 as IRoomWidgetFactory;
         Component(this.var_47).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_CLOSE,this.onWidgetTrackingEvent);
         Component(this.var_47).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_DEFAULT,this.onWidgetTrackingEvent);
         Component(this.var_47).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_DANCE,this.onWidgetTrackingEvent);
         Component(this.var_47).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_EFFECTS,this.onWidgetTrackingEvent);
      }
      ...
      {
         this.var_129 = param2 as IHabboHelp;
         this.var_129.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_129.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2359)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1528);
            this.var_2359 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1258,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_806,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_295,this.onRoomAction);
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_300,this.onRoomAction);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_311 = param2 as IAdManager;
         this.var_311.events.addEventListener(AdEvent.const_518,this.onRoomAdLoad);
      }
      
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_181 = param2 as IHabboToolbar;
         this.var_181.events.addEventListener(HabboToolbarEvent.const_39,this.onToolbarClick);
      }
      ...
      {
         if(param1.type == RoomEngineEvent.const_295)
         {
            if(this.var_1706 < 1)
            {
               if(!this.var_304)
               {
                  this.var_304 = new Timer(60000,1);
                  this.var_304.addEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
                  this.var_304.start();
               }
            }
         }
         else if(param1.type == RoomEngineEvent.const_300)
         {
            if(this.var_304)
            {
               this.var_304.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
            ...
            if(this._connection)
            {
               if(this.var_431)
               {
                  ...
                  if(this._roomEngine)
                  {
                     ...
                     _loc4_ = this._roomEngine.getRoomObjectCount(-1,-1,RoomObjectCategoryEnum.const_28) + this._roomEngine.getRoomObjectCount(-1,-1,RoomObjectCategoryEnum.const_26);
                     _loc2_ = "Avatars: " + _loc3_ + ", Objects: " + _loc4_;
                  }
                  this._connection.send(new ConversionPointMessageComposer("Performance","fps",String(this.var_431.frameRate),_loc2_));
                  ++this.var_1706;
               }
            }
         }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_595)
         {
            this.var_595.track(param1.iconName);
         }
      }
      ...
      {
         this.var_596.chatLagDetected(param1);
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_505 > -1 && _loc2_ < this.var_505)
         {
            ++this.var_1707;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1707);
         }
         if(this.var_505 > -1 && _loc2_ - this.var_505 > 15000)
         {
            ++this.var_1708;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1708);
         }
         this.var_505 = _loc2_;
         if(this.var_246 != null)
         {
            this.var_246.update(param1,this.var_505);
         }
         if(this.var_247 != null)
         {
            this.var_247.update(param1,this.var_505);
         }
         if(this.var_431 != null)
         {
            this.var_431.trackUpdate(param1,this,this.var_505);
         }
         if(this.var_596 != null)
         {
            this.var_596.update(this.var_505);
         }
      }
   }
}
