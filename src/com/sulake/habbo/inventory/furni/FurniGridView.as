   ...
   public class FurniGridView
   {
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_41)
         {
            ...
            this.var_67.toggleItemSelection(this._category,this.var_260.getGridItemIndex(param1.window));
            this.var_624 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_624 != null && this.var_624 == param2 && !this.var_67.isTradingOpen)
         {
