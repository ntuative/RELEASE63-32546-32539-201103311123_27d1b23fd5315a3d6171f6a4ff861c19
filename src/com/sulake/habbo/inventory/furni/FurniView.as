package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_2095:int = 0;
      
      private const const_953:int = 1;
      
      private const const_1765:int = 2;
      
      private const const_1764:int = 3;
      
      private const const_1763:int = 42;
      
      private const const_1766:int = 120;
      ...
      private var var_844:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_493 = param6;
         this.var_493.events.addEventListener(SongInfoReceivedEvent.TRAX_SONG_INFO_RECEIVED,this.onSongInfoReceivedEvent);
         this.var_423 = new Map();
         this.var_423.add(FurniModel.const_47,new FurniGridView(this.var_67,FurniModel.const_47,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_423.add(FurniModel.const_51,new FurniGridView(this.var_67,FurniModel.const_51,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_493)
            {
               this.var_493.events.removeEventListener(SongInfoReceivedEvent.TRAX_SONG_INFO_RECEIVED,this.onSongInfoReceivedEvent);
               this.var_493 = null;
            }
            this.var_194 = null;
            this._disposed = true;
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_423.getValue(this.var_424);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_67.getCategoryContent(this.var_424);
         if(!this.var_67.isListInited())
         {
            _loc2_ = this.const_953;
         }
         ...
         {
            _loc2_ = this.const_1764;
         }
         if(this.var_2269 == _loc2_)
         {
            return;
         }
         this.var_2269 = _loc2_;
      ...
      public function clearViews() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = [FurniModel.const_47,FurniModel.const_51];
         var _loc4_:int = 0;
         while(_loc4_ < _loc1_.length)
         {
            _loc2_ = _loc1_[_loc4_];
            _loc3_ = this.var_423.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_423.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_423.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_67.getGroupItemInIndex(_loc3_,this.var_424);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            if(_loc5_.category == FurniCategory.const_394)
            {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_844 && this.var_844.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
         ...
         if(_loc13_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.category == FurniCategory.const_645)
               {
                  _loc21_ = this.var_493.musicController.getSongInfo(_loc5_.extra);
                  if(_loc21_ != null)
                  {
                  ...
                  {
                     this.var_493.musicController.requestSongInfoWithoutSamples(_loc5_.extra);
                     this.var_194.push(_loc5_.extra);
                  }
               }
            }
         ...
         if(_loc14_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.category == FurniCategory.const_645)
               {
                  _loc22_ = this.var_493.musicController.getSongInfo(_loc5_.extra);
                  if(_loc22_ != null)
                  {
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1766)
         {
            _loc3_ = this.const_1766;
         }
         else if(_loc3_ < this.const_1763)
         {
            _loc3_ = this.const_1763;
         }
         else
         {
         ...
         else if(param1.type == WindowEvent.const_63)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModel.const_363);
            }
         }
      }
      ...
      {
         if(this.var_194.indexOf(param1.id as Number) != -1)
         {
            this.updateActionView();
            while(this.var_194.indexOf(param1.id as Number) != -1)
            {
               this.var_194.splice(this.var_194.indexOf(param1.id as Number),1);
            }
         }
      }
   }
