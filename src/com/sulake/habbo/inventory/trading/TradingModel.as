package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_720 = true;
         this.state = const_179;
         this.var_58.setup(param1,param3,param4,param6);
         this.var_58.updateItemList(this.var_842);
         this.var_58.updateItemList(this.var_1564);
         this.var_58.method_2();
      ...
      public function close() : void
      {
         if(this.var_720)
         {
            if(this._state != const_189 && this._state != const_277)
            {
      ...
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_843 + " OTHER: " + this.var_1295);
         ...
         {
            case const_189:
               if(param1 == const_179 || param1 == const_277)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_58.alertPopup(TradingView.const_1247);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_842)
            {
               this.var_843 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1295 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_58.method_2();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_842)
            {
               this.var_58.alertPopup(TradingView.const_1237);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_281.length < const_1627)
         {
