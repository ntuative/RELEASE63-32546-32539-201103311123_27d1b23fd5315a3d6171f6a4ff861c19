package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1027:uint = 4284532064;
      
      private static const const_1028:uint = 2577770;
      ...
      private var var_679:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager, param6:IHabboSoundManager)
      {
         ...
         this.var_679 = new ItemPopupCtrl(_loc9_,this._assetLibrary);
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_2029 = this.createMinimizedWindow();
         }
         if(!this.var_2823)
         {
            return this.var_72;
      ...
      public function method_2() : void
      {
         ...
         if(this.var_72)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_17.ownUserAccepts ? uint(const_1027) : uint(const_1028);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_17.otherUserAccepts ? uint(const_1027) : uint(const_1028);
            }
      ...
      public function setSelection(param1:GroupItem) : void
      {
         ...
         if(param1)
         {
            ...
            this._selection.isSelected = true;
         }
      }
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_1642)
            {
            ...
            this.var_679.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_478);
            this.var_679.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_679.hideDelayed();
         }
      }
      ...
      private function getTraxSongFurniName(param1:GroupItem, param2:String, param3:Boolean, param4:uint = 1.0, param5:Boolean = false) : String
      {
         ...
         var _loc7_:ISongInfo = this.var_493.musicController.getSongInfo(_loc6_.extra);
         if(_loc7_ != null)
         {
         ...
         else if(param3)
         {
            ...
            this.var_493.musicController.requestSongInfoWithoutSamples(_loc6_.extra);
         }
         return param2;
      }
         ...
         if(this.var_194.length > 0)
         {
            ...
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_17.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_17.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_679.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_478);
               }
            }
            else
            {
