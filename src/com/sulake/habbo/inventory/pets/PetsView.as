package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private var var_374:PetsGridItem;
      ...
      {
         this.updateGrid();
         this.updatePreview(this.var_374);
      }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = this.var_374.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_63)
         {
            ...
            {
               case "tab_floor":
                  this.var_67.switchCategory(FurniModel.const_47);
                  break;
               case "tab_wall":
                  this.var_67.switchCategory(FurniModel.const_51);
            }
            this.selectPetsTab();
         }
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(this.var_374 != null)
         {
            this.var_374.setSelected(false);
         }
         this.var_374 = param1;
         if(this.var_374 != null)
         {
            this.var_374.setSelected(true);
         }
