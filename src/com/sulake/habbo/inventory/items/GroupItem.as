package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_858:int = 0;
      
      protected var var_689:BitmapData;
      ...
      protected var var_2863:BitmapData;
      
      private const const_2047:int = 8947848;
      
      private const const_2048:int = 13421772;
      
      private const const_1775:Number = 1;
      
      private const const_1776:Number = 0.2;
      ...
      private function method_4(param1:BitmapData) : void
      {
         this.var_689 = param1;
         this.var_1571 = true;
         this.var_858 = -1;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2862 == FurniModel.const_47)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1487));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2092);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
            ...
            this.var_858 = _loc2_.id;
         }
         else
         {
            this.method_4(_loc2_.data);
            this.var_858 = -1;
         }
         this.var_1571 = true;
      }
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_793)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1776;
               _loc1_.blend = this.const_1776;
            }
            else
            {
               this._window.blend = this.const_1775;
               _loc1_.blend = this.const_1775;
            }
         }
         if(this.isSelected)
         {
         ...
         if(_loc5_)
         {
            if(this.var_2091 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2863;
               _loc5_.visible = true;
            }
            else
            {
