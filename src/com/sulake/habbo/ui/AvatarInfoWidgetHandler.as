package com.sulake.habbo.ui
{
   ...
   public class AvatarInfoWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            if(this._container)
            {
               ...
               {
                  this._container.toolbar.events.removeEventListener(HabboToolbarEvent.const_39,this.onToolbarClicked);
               }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         ...
         if(this._container.toolbar)
         {
            this._container.toolbar.events.addEventListener(HabboToolbarEvent.const_39,this.onToolbarClicked);
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_886);
         _loc1_.push(RoomWidgetUserActionMessage.const_887);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_886:
               this.dispatchOwnAvatarInfo();
               break;
            case RoomWidgetUserActionMessage.const_887:
