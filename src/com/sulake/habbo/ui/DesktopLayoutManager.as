package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private const const_1379:String = "room_view";
      
      private const const_2077:String = "room_widget";
      
      private var var_52:IWindowContainer;
      
      private var var_787:int = 50;
      
      private var var_2903:XML = null;
      ...
      public function setLayout(param1:XML, param2:IHabboWindowManager, param3:IHabboConfigurationManager) : void
      {
         ...
         this.var_2903 = param1.copy();
         this.var_52 = param2.buildFromXML(param1,0) as IWindowContainer;
         if(this.var_52 == null)
         {
         ...
         var _loc4_:IWindowContainer = this.var_52.desktop as IWindowContainer;
         _loc4_.addChildAt(this.var_52,0);
         if(param3)
         {
            if(param3.getKey("friendbar.enabled") == "com.sulake.room.object.logic")
            {
               this.var_52.findChildByTag("room_widget_infostand").y = this.var_52.findChildByTag("room_widget_infostand").y - 32;
            }
         }
         var _loc6_:int = 0;
         while(_loc6_ < this.var_52.numChildren)
         {
            _loc5_ = this.var_52.getChildAt(_loc6_);
            _loc7_ = false || false;
            if(_loc5_.testParamFlag(_loc7_))
            {
               _loc5_.addEventListener(WindowEvent.const_310,this.trimContainer);
            }
            _loc6_++;
         }
      }
      ...
      public function addWidgetWindow(param1:IWindow) : Boolean
      {
         ...
         {
            if(String(_loc2_[_loc4_]).indexOf(this.const_2077) == 0)
            {
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = this.var_52.getChildByTag(this.const_1379) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function set toolbarOrientation(param1:String) : void
      {
         ...
         switch(param1)
         {
            case "LEFT":
               ...
               _loc2_.width = this.var_52.desktop.width - this.var_787;
               _loc2_.y = 0;
            ...
            case "TOP":
               ...
               _loc2_.height = this.var_52.desktop.height - this.var_787;
               break;
            case "BOTTOM":
               _loc2_.x = 0;
               _loc2_.width = this.var_52.desktop.width;
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = this.var_52.findChildByTag(this.const_1379) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
