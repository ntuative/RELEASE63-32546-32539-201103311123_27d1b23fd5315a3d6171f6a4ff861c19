package com.sulake.habbo.ui
{
   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      {
         return RoomWidgetEnum.const_576;
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_290,this.onFigureUpdate);
            }
            if(this._inventory != null)
            {
               this._inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_651,this.onAvatarEffectsChanged);
               this._inventory.events.removeEventListener(HabboInventoryHabboClubEvent.const_891,this.onHabboClubSubscriptionChanged);
            }
            if(this.var_181 != null)
            {
               this.var_181.events.removeEventListener(HabboToolbarEvent.const_69,this.onHabboToolbarEvent);
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_459,this.onHelpTutorialEvent);
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_116,this.onHelpTutorialEvent);
            }
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_290,this.onFigureUpdate);
         }
         this._inventory = this._container.inventory;
         if(this._inventory != null)
         {
            this._inventory.events.addEventListener(HabboInventoryEffectsEvent.const_651,this.onAvatarEffectsChanged);
            this._inventory.events.addEventListener(HabboInventoryHabboClubEvent.const_891,this.onHabboClubSubscriptionChanged);
         }
         this.var_181 = this._container.toolbar;
         if(this.var_181 != null)
         {
         ...
         if(this._container.habboHelp != null)
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_459,this.onHelpTutorialEvent);
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_116,this.onHelpTutorialEvent);
         }
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc2_ != this.var_1538)
            {
               ...
               this.var_1991 = _loc1_;
            }
            else
            {
               _loc1_ = this.var_1991;
            }
         }
         if(this.var_181 != null)
         {
            _loc5_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1150,HabboToolbarIconEnum.MEMENU);
            if(_loc1_ != null)
            {
               _loc5_.bitmapData = _loc1_;
            }
            this.var_181.events.dispatchEvent(_loc5_);
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_855);
         _loc1_.push(RoomWidgetDanceMessage.const_664);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_680);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_761);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_856);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_695);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_849);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_415);
         _loc1_.push(RoomWidgetStopEffectMessage.const_835);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1468);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1051);
         _loc1_.push(RoomWidgetToolbarMessage.const_740);
         _loc1_.push(RoomWidgetToolbarMessage.const_748);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_409);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1624);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1248);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_894);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_933);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_769);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1637);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_775);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_881);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_909);
         _loc1_.push(RoomWidgetClothingChangeMessage.const_404);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_933:
               ...
               break;
            case RoomWidgetWaveMessage.const_855:
            ...
            case RoomWidgetGetEffectsMessage.const_680:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_761:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_856:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_415:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1181)
               {
            ...
            case RoomWidgetOpenInventoryMessage.const_849:
               ...
               if(this._inventory != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_1079:
                        this._catalog.openCatalogPage(CatalogPageName.const_1736,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1038:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_320);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1535:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_695:
            case RoomWidgetStopEffectMessage.const_835:
            ...
            case RoomWidgetNavigateToRoomMessage.const_1051:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_894:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_740:
               ...
               if(this.var_181)
               {
                  this.var_181.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_54,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(this._inventory != null)
                  {
                     _loc12_ = false;
            ...
            case RoomWidgetToolbarMessage.const_748:
               ...
               {
                  this.var_181.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_470,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_409:
               ...
               if(this._container)
               {
                  ...
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_592));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_769:
            ...
            case RoomWidgetStoreSettingsMessage.const_775:
               ...
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_391,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_881:
               this._container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_391,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_909:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_597));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_404:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_847));
               break;
            default:
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_706));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_116:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_116));
               break;
            case HabboHelpTutorialEvent.const_459:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_517));
         }
      }
