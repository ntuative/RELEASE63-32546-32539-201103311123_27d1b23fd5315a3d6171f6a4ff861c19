   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_161,this.onUserTags);
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_152,this.onBadgeImage);
            }
            if(this._container.roomSessionManager != null)
            {
               this._container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_169,this.onFigureUpdate);
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_161,this.onUserTags);
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_152,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
            this._container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_169,this.onFigureUpdate);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_580.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_580.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_357);
         _loc1_.push(RoomWidgetUserActionMessage.const_889);
         _loc1_.push(RoomWidgetUserActionMessage.const_693);
         _loc1_.push(RoomWidgetUserActionMessage.const_915);
         _loc1_.push(RoomWidgetUserActionMessage.const_854);
         _loc1_.push(RoomWidgetUserActionMessage.const_726);
         _loc1_.push(RoomWidgetUserActionMessage.const_523);
         _loc1_.push(RoomWidgetUserActionMessage.const_940);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_276);
         _loc1_.push(RoomWidgetFurniActionMessage.const_888);
         _loc1_.push(RoomWidgetFurniActionMessage.const_688);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_792);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_718);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_648);
         _loc1_.push(RoomWidgetUserActionMessage.const_555);
         _loc1_.push(RoomWidgetUserActionMessage.const_715);
         _loc1_.push(RoomWidgetUserActionMessage.const_454);
         _loc1_.push(RoomWidgetUserActionMessage.const_1527);
         _loc1_.push(RoomWidgetPetCommandMessage.const_551);
         _loc1_.push(RoomWidgetPetCommandMessage.const_939);
         _loc1_.push(RoomWidgetUserActionMessage.const_535);
         _loc1_.push(RoomWidgetUserActionMessage.const_377);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_842);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_555)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_377 || param1.type == RoomWidgetUserActionMessage.const_535 || param1.type == RoomWidgetUserActionMessage.const_454)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_357:
            ...
            case RoomWidgetUserActionMessage.const_535:
               ...
               break;
            case RoomWidgetUserActionMessage.const_915:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1262,_loc3_.name);
               this._container.events.dispatchEvent(_loc8_);
               break;
            case RoomWidgetUserActionMessage.const_854:
            ...
            case RoomWidgetUserActionMessage.const_523:
               ...
               break;
            case RoomWidgetUserActionMessage.const_940:
            ...
            case RoomWidgetUserActionMessage.const_709:
               ...
               break;
            case RoomWidgetUserActionMessage.const_454:
            ...
            case RoomWidgetUserActionMessage.const_377:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_792:
            ...
            case RoomWidgetGetBadgeDetailsMessage.const_718:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_648:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               if(_loc8_.getString(RoomWidgetEnum.const_438) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetEnum.const_438);
               }
               ...
               {
                  _loc26_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_307);
               ...
               _loc11_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1179);
               _loc12_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1268);
            ...
            case RoomObjectCategoryEnum.const_34:
               ...
               if(_loc13_.type == RoomObjectTypeEnum.const_198)
               {
                  this._container.roomSession.userDataManager.requestPetInfo(_loc13_.webID);
                  return null;
               }
               if(_loc13_.type == RoomObjectTypeEnum.const_203)
               {
                  _loc14_ = "null";
               ...
               {
                  if(_loc13_.type != RoomObjectTypeEnum.const_880)
                  {
                     return null;
                  }
                  _loc14_ = "null";
               ...
               if(_loc19_ != null)
               {
                  _loc15_.carryItem = _loc19_.getModel().getNumber(RoomObjectVariableEnum.const_580);
               }
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.const_118)
               {
                  _loc15_.realName = this._container.sessionDataManager.realName;
               }
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.const_134)
               {
                  ...
                  if(_loc19_ != null)
                  {
                     _loc33_ = _loc19_.getModel().getString(RoomObjectVariableEnum.const_744);
                  ...
                  if(!_loc29_)
                  {
                     _loc15_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1249;
                  }
                  if(!_loc30_)
                  {
                     _loc15_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1054;
                  }
               ...
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc16_.push(RoomWidgetUserInfoUpdateEvent.const_1505);
               }
               else
               {
               ...
               _loc21_ = _loc13_.sex;
               _loc22_ = this._container.avatarRenderManager.createAvatarImage(_loc20_,AvatarScaleType.const_53,_loc21_);
               if(_loc22_ != null)
               {
      ...
      {
         return [RoomSessionUserBadgesEvent.const_68,RoomSessionUserGivableBadgesEvent.const_68];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_68:
               ...
               break;
            case RoomSessionUserGivableBadgesEvent.const_68:
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_580.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_580.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_744);
