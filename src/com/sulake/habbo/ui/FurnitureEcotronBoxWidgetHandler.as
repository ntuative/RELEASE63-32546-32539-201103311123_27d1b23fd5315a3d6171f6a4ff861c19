package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_658,RoomWidgetEcotronBoxOpenMessage.const_817,RoomWidgetEcotronBoxOpenedMessage.const_1555];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_658:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_817:
