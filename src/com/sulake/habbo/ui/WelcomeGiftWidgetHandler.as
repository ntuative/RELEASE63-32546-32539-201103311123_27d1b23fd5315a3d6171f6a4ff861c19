package com.sulake.habbo.ui
{
   ...
   public class WelcomeGiftWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function addMessageEvents() : void
      {
         ...
         this.var_704 = [];
         this.var_704.push(new WelcomeGiftStatusEvent(this.onWelcomeGiftStatus));
         this.var_704.push(new ChangeEmailResultEvent(this.onChangeEmailResult));
      ...
      {
         var _loc1_:* = null;
         if(!this._container || !this._container.connection || !this.var_704)
         {
            return;
         }
         for each(_loc1_ in this.var_704)
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetFurniActionMessage.const_701);
         _loc1_.push(RoomWidgetChangeEmailMessage.const_659);
         return _loc1_;
      }
