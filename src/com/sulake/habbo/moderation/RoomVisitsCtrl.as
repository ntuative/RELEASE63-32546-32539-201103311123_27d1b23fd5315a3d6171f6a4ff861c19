package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_959:Array = [];
      
      private static var var_1813:int = 200;
      ...
      {
         this.var_772 = IWindowContainer(this.var_35.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1594;
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_959.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_772.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_959.length < var_1813)
         {
            ...
            param1.width = this.var_772.width;
            param1.height = this.var_772.height;
            var_959.push(param1);
         }
         else
         {
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1458)
         {
