package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_742:IssueMessageData = null;
      
      private var var_743:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2381 = param2.pickerUserName;
         this.var_1419 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1130 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1129;
         }
         if(this.var_742 == null || param1.timeStamp < this.var_742.timeStamp)
         {
            this.var_742 = param1;
         }
         if(this.var_743 == null || param1.priority > this.var_743.timeStamp)
         {
            this.var_743 = param1;
         }
      }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_743;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_742;
         if(_loc2_ == null)
         {
