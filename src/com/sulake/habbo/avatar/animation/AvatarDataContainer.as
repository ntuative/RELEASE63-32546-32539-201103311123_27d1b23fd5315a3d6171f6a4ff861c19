package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1820:Number = 1.0;
      
      private var var_1819:Number = 1.0;
      
      private var var_1823:Number = 1.0;
      
      private var _alphaMultiplier:Number = 1.0;
      
      private var var_1258:Map;
      ...
      {
         super();
         this.var_1976 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2760 = parseInt(_loc2_,16);
         this.var_2761 = parseInt(_loc3_,16);
         ...
         this.var_1020 = new ColorTransform(this.var_1820,this.var_1819,this.var_1823,this._alphaMultiplier);
         this.var_1258 = this.generatePaletteMapForGrayscale(this.var_2761,this.var_2760);
      }
      ...
      {
         return this.var_1258.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1258.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1258.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1258.getValue("alphas") as Array;
      }
