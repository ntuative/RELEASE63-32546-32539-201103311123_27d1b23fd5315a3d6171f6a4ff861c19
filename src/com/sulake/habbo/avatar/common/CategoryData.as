package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_250)
         {
            for each(_loc2_ in this.var_250 as Array)
            {
               if(_loc2_)
               {
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(this.var_921 >= 0 && this._parts.length > this.var_921)
         {
            _loc2_ = this._parts[this.var_921];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
      ...
      public function getSelectedColorIds() : Array
      {
         ...
         if(!this.var_250 || this.var_250.length == 0)
         {
            return null;
         }
         var _loc1_:Array = this.var_250[0] as Array;
      ...
      public function getPalette(param1:int) : Array
      {
         ...
         if(this.var_250.length <= param1)
         {
            return null;
         }
         return this.var_250[param1] as Array;
      }
      
      public function getCurrentPart() : AvatarEditorGridPartItem
      {
         return this._parts[this.var_921] as AvatarEditorGridPartItem;
      }
