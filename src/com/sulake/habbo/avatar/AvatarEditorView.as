package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1299:IWindowContainer;
      
      public static var var_1569:IWindowContainer;
      
      public static var var_2078:int = 6710886;
      ...
      private var var_533:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1230 = [];
         this.var_1502 = [AvatarEditorFigureCategory.const_660,AvatarEditorFigureCategory.const_52,AvatarEditorFigureCategory.const_250,AvatarEditorFigureCategory.const_767,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_108];
         super();
         ...
         if(var_1299 == null)
         {
            ...
            var_1299 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1569 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1569 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_457 = new Timer(1000);
         this.var_457.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1502;
         }
         for each(_loc6_ in param4)
         {
            this.var_1230.push(_loc6_);
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_457.stop();
            this.var_457.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_457 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1502);
         }
         if(param1.length != this.var_1230.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1230.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_533 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_533.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_533.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1230.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_533.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_533.numSelectables)
               {
                  this.var_533.getSelectableAt(_loc6_).x = this.var_533.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1502;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_44) && (this.var_1924 == AvatarEditorSideCategory.const_108 || this.var_2691))
         {
         ...
         this.setViewToCategory(this.var_342);
      }
      ...
      {
         if(this.var_1924 == AvatarEditorSideCategory.const_108)
         {
            this.var_2691 = false;
            this.setSideContent(AvatarEditorSideCategory.const_644);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_644:
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_342 = param1;
         this.var_533.setSelected(this.var_533.getSelectableByName(param1));
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "save":
                  ...
                  this.var_2502 = new Date().valueOf();
                  this.var_2692 = false;
                  this.var_457.start();
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_534)
         {
            ...
            this.var_534 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_534.procedure = this.stripClubDialogEventProc;
            this.var_534.center();
         }
         else
         {
      ...
      private function canChangeOutfit() : Boolean
      {
         ...
         return _loc1_ - this.var_2502 > 5000;
      }
   }
}
