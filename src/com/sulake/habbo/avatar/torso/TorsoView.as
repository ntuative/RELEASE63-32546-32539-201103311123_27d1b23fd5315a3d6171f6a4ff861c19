   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_38)
         {
            ...
            var_38["null"] = new AvatarEditorGridView(var_67,FigureData.const_274,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_67,FigureData.const_188,_windowManager,_assetLibrary);
         ...
         if(var_67 && var_149 == "")
         {
            var_67.switchCategory(FigureData.const_188);
         }
      }
