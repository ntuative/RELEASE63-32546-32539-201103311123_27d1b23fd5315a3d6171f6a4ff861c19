package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1366:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1367:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_1191:AvatarEditorHandler;
      ...
      private var var_1464:IHabboAvatarEditorDataSaver = null;
      ...
      {
         this.var_948 = FigureData.const_81;
      ...
      private function init(param1:Array = null) : void
      {
         ...
         if(!this.var_196)
         {
            this.var_636 = new Dictionary();
            this.var_636["null"] = new FigureData(this);
            this.var_636["null"] = new FigureData(this);
            _loc2_ = this.var_636["null"];
            _loc3_ = this.var_636["null"];
            _loc2_.loadAvatarData(const_1366,FigureData.const_81);
            _loc3_.loadAvatarData(const_1367,FigureData.FEMALE);
            this.var_103 = new Map();
            this.var_521 = new Map();
            this.var_103.add(AvatarEditorFigureCategory.const_660,new BodyModel(this));
            this.var_103.add(AvatarEditorFigureCategory.const_52,new HeadModel(this));
            this.var_103.add(AvatarEditorFigureCategory.const_250,new TorsoModel(this));
            this.var_103.add(AvatarEditorFigureCategory.const_767,new LegsModel(this));
            ...
            this.var_521.add(AvatarEditorSideCategory.const_108,new WardrobeModel(this));
            this.var_521.add(AvatarEditorSideCategory.const_495,new ClubPromoModel(this));
            this.var_196 = true;
         }
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var _loc4_:FigureData = this.var_636[param2];
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this.var_262 == null)
            {
               this.var_262 = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_73,HabboWindowStyle.const_32,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_262.addChild(this._view.window);
               if(param5)
               {
                  this.var_262.center();
               }
            ...
            this.var_262.visible = !this.var_262.visible;
         }
         this._view.show();
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_660);
         }
      ...
      {
         var _loc2_:ISideContentModel = this.var_521.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (this.var_522 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,this.onAvatarRendererReady);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         this.var_969 = this.var_522.getFigureData(AvatarType.const_119);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1191 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_636[this.var_948];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1464 != null)
         {
            ...
            this.var_1464.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1831;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_1190 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1365)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1569.clone() as IWindowContainer,param1,_loc13_);
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_522.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_522.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            ...
            if(_loc15_)
            {
               ...
               if(_loc21_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1299.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1618)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_1190 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1299.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_1190 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_521.getValue(AvatarEditorSideCategory.const_108);
      }
