package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_916:String = "RCL_LOADER_READY";
      
      private static const const_341:String = "RCL_PUBLICROOM_";
      
      private static const const_1760:int = 0;
      
      private static const const_953:int = 1;
      
      private static const name_4:int = 2;
      
      private static const const_424:String = "place_holder";
      
      private static const const_605:String = "wall_place_holder";
      
      private static const const_606:String = "pet_place_holder";
      
      private static const PLACE_HOLDER_DEFAULT:String = const_424;
      
      private static const const_607:String = "room";
      
      private static const TILE_CURSOR:String = "tile_cursor";
      
      private static const const_952:String = "selection_arrow";
      ...
      private var var_880:Map = null;
      
      private var var_419:Dictionary;
      
      private var var_879:Map = null;
      
      private var var_198:PublicRoomData = null;
      
      private var var_1342:Map = null;
      ...
      {
         this.var_343 = new Dictionary();
         this._wallItems = new Dictionary();
         this.var_419 = new Dictionary();
         this.var_2183 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         this.var_2179 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2181 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         this.var_2180 = param2.getKey("public.room.dynamic.download.url","");
      ...
      private function initPetData() : void
      {
         ...
         {
            this.var_419[_loc3_] = _loc2_;
            this.var_880.add(_loc2_,_loc3_);
            _loc2_++;
         }
      ...
      private function initFurnitureData() : void
      {
         ...
         var _loc1_:Array = this.var_289.getFurniData(this);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_485.length;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc4_ = this.var_485.getWithIndex(_loc3_) as AssetLibrary;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
         ...
         {
            for(_loc1_ in this.var_419)
            {
               delete this.var_419[_loc1_];
            }
            this.var_419 = null;
         }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc2_.type == "s")
            {
               this.var_420.add(_loc3_,_loc4_);
               if(this.var_343[_loc7_] == null)
               {
                  this.var_343[_loc7_] = 1;
               }
            }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2182)
         {
            ...
            {
               this._stateEvents.dispatchEvent(new Event(const_916));
            }
         }
      }
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         if(this.var_198 != null && (this.var_198.type == param1 || this.var_198.hasWorldType(param1)))
         {
         ...
         {
            return RoomObjectCategoryEnum.const_338;
         }
         return RoomObjectCategoryEnum.const_160;
      }
      ...
      {
         return [const_424,const_605,const_606,const_607,TILE_CURSOR,const_952];
      }
      
      public function getActiveObjectType(param1:int) : String
      {
         var _loc2_:String = this.var_420.getValue(param1) as String;
      ...
      {
         return this.var_880.getValue(param1) as String;
      }
      
      public function getPetColor(param1:int, param2:int) : PetColorResult
      {
         var _loc3_:Map = this.var_879[param1];
         if(_loc3_ != null)
         {
      ...
      {
         if(this.var_198 != null && this.var_198.hasWorldType(const_341 + param1))
         {
            return this.var_198.type;
         }
         return param1;
      }
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_236 || param1 == RoomObjectVisualizationEnum.const_72 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
         ...
         switch(_loc2_)
         {
            ...
            default:
               ...
               while(_loc9_ < _loc7_.length)
               {
                  ...
                  _loc8_.push(this.var_2180 + _loc10_);
                  _loc9_++;
               }
               return _loc8_;
         }
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.const_28:
                     if(this.var_343[_loc4_] == null)
                     {
                        this.var_343[_loc4_] = 1;
                     }
                     break;
                  case RoomObjectCategoryEnum.const_26:
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1342.getValue(param1) != null)
         {
            this.var_198 = this.var_1342.getValue(param1) as PublicRoomData;
         }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2183.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1578);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            ...
            else if(this.var_419[_loc5_] != null)
            {
         ...
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_594,_loc5_);
         }
      ...
      private function extractPetDataFromLoadedContent(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc6_ = this.var_419[param1];
            this.var_879.add(_loc6_,_loc3_);
         }
      }
      ...
      private function extractPublicRoomDataFromLoadedContent(param1:String, param2:IAssetLibrary) : void
      {
         ...
         this.var_1342.add(param1,_loc4_);
         this.var_198 = _loc4_;
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_709.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_709.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         if(_loc3_ == null)
         {
            _loc4_ = this.var_709.getValue(_loc2_);
            if(_loc4_ != null)
            {
      ...
      private function extractPublicRoomFromXML(param1:String, param2:XML) : PublicRoomData
      {
         ...
         {
            _loc6_ = _loc3_[_loc5_];
            _loc7_ = const_341 + String(_loc6_.@name);
            _loc8_ = 32;
            _loc9_ = 1;
      ...
      {
         if(this.getObjectCategory(const_341 + param1) == RoomObjectCategoryEnum.const_77)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_198.getWorldHeightScale(const_341 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_198 != null)
         {
            return this.var_198.getWorldScale(const_341 + param1);
         }
         return 32;
      }
      ...
      {
         this.var_420.remove(param1);
         this.var_420.add(param1,param2);
      }
   }
}
