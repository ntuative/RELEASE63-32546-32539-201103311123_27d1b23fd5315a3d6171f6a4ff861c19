package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureIceStormLogic extends FurnitureMultiStateLogic
   {
      ...
      private var var_2780:Number = 0.0;
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         {
            this.var_1769 = _loc2_;
            this.var_2780 = param1.extra;
            this.var_1266 = lastUpdateTime + _loc3_;
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1266 > 0 && param1 >= this.var_1266)
         {
            this.var_1266 = 0;
            _loc2_ = new RoomObjectDataUpdateMessage(this.var_1769,String(this.var_1769),this.var_2780);
