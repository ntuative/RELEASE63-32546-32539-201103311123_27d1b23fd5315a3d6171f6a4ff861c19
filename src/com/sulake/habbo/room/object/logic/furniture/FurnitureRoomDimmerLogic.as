package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureRoomDimmerLogic extends FurnitureLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectWidgetRequestEvent.const_132,RoomObjectWidgetRequestEvent.const_106,RoomObjectDimmerStateUpdateEvent.const_62];
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_1730)
         {
            if(eventDispatcher != null && object != null)
            {
               ...
               _loc7_ = new RoomObjectWidgetRequestEvent(RoomObjectWidgetRequestEvent.const_106,_loc1_,_loc2_);
