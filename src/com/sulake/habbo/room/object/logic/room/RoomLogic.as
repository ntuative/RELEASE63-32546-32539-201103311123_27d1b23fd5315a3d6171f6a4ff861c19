package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1636:int = 255;
      
      private var var_1520:uint = 16777215;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_532,RoomObjectMouseEvent.const_130];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1050,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_868,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_872,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_796,1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1245)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1636;
            if(_loc2_ - this.var_1245 >= this.var_1952)
            {
               _loc3_ = this.var_1244;
               _loc4_ = this.var_1950;
               this.var_1245 = 0;
            }
            else
            {
               _loc7_ = this.var_1520 >> 16 & 255;
               _loc8_ = this.var_1520 >> 8 & 255;
               _loc9_ = this.var_1520 & 255;
               _loc10_ = this.var_1244 >> 16 & 255;
               _loc11_ = this.var_1244 >> 8 & 255;
               _loc12_ = this.var_1244 & 255;
               _loc13_ = (_loc2_ - this.var_1245) / this.var_1952;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1951 + (this.var_1950 - this.var_1951) * _loc13_;
               this._color = _loc3_;
               this.var_1636 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_868,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_665:
               param2.setString(RoomObjectVariableEnum.const_883,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_879:
               param2.setString(RoomObjectVariableEnum.const_642,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_649:
               param2.setString(RoomObjectVariableEnum.const_906,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_536:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_265)
               {
                  _loc5_ = "null";
               }
               this.var_531.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_821:
               _loc4_ = this.var_531.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_531.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1040,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1046:
               param2.setNumber(RoomObjectVariableEnum.const_872,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1117:
               param2.setNumber(RoomObjectVariableEnum.const_796,_loc3_);
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         this.var_1520 = this._color;
         this.var_1951 = this.var_1636;
         this.var_1244 = _loc3_;
         this.var_1950 = _loc4_;
         this.var_1245 = getTimer();
         this.var_1952 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_447,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1460,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1745,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1744,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_447,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_168 || _loc12_ == RoomPlaneData.const_340)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
