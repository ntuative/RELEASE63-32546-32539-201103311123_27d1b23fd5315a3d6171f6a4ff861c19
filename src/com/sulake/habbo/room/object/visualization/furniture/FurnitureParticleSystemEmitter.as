package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1485:String = "cone";
      
      public static const const_1506:String = "plane";
      
      public static const const_1482:String = "sphere";
      ...
      private var var_999:Number = 0.1;
      ...
      public function reset() : void
      {
         ...
         this.var_998 = 0;
         this.var_897 = false;
         this.init(0,0,0,this._direction,this.var_2656,this.var_999,this.var_2658,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_1221.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_897 = true;
         if(this.var_998 < this.var_1493)
         {
            if(this.age > 1)
            {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2659)
         {
            switch(this.var_2655)
            {
               case const_1485:
            ...
            _loc4_.init(param1.x,param1.y,param1.z,_loc3_,this._energy,this.var_999,_loc6_,_loc7_,_loc9_,_loc8_);
            this.var_378.push(_loc4_);
            ++this.var_998;
            _loc10_++;
         }
      }
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1221.length);
         return this.var_1221[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_998 < this.var_1493)
         {
            if(this.age % this.var_2654 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_998 < this.var_1493)
         {
            ...
            this.y = (2 - this.var_269) * this.y - (1 - this.var_269) * this.lastY + this.var_1913 * this.var_999 * this.var_999;
         ...
         for each(_loc2_ in this.var_378)
         {
            ...
            _loc2_.y = (2 - this.var_269) * _loc2_.y - (1 - this.var_269) * _loc2_.lastY + this.var_1913 * this.var_999 * this.var_999;
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            this.var_378.splice(this.var_378.indexOf(_loc2_),1);
            _loc2_.dispose();
         }
      }
