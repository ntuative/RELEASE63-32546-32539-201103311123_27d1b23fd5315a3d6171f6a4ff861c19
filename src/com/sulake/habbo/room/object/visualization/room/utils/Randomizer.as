package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1997:int = 16777216;
      ...
      private var var_2027:int = 16777216;
      
      private var var_2915:int = 69069;
      ...
      {
         var _loc1_:int = this.var_2915 * this.var_2028 + this.var_2914;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_2027;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_2027 * param2);
      }
   }
}
