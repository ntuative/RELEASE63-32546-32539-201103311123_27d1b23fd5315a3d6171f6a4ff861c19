package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1654:int = 16777215;
      
      public static const const_1750:int = 13421772;
      
      private static const const_1003:int = 16777215;
      
      private static const const_1005:int = 13421772;
      
      private static const const_1006:int = 10066329;
      
      private static const const_1004:int = 10066329;
      
      public static const const_1475:int = 16777215;
      
      public static const const_1705:int = 13421772;
      
      public static const const_1669:int = 10066329;
      ...
      private var var_531:RoomPlaneBitmapMaskParser = null;
      
      private var var_1593:String = null;
      
      private var _floorType:String = null;
      
      private var var_1591:String = null;
      
      private var var_2680:String = null;
      
      private var var_1224:uint = 16777215;
      
      private var var_2681:int = 255;
      
      private var var_2679:int = 255;
      
      private var var_2678:int = 255;
      
      private var var_1917:Boolean = true;
      
      private var var_1584:int = 0;
      
      private var var_1888:int = -1000;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_531 = new RoomPlaneBitmapMaskParser();
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            {
               if(_loc3_.type == RoomPlane.const_122 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1050);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1106);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            if(_loc12_ == RoomPlaneData.const_186)
            {
               ...
               if(_loc14_.z != 0)
               {
                  _loc13_.color = const_1654;
               }
               else
               {
                  _loc13_.color = const_1750;
               }
            ...
            else if(_loc12_ == RoomPlaneData.const_168)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_122,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
                  _loc13_.hasTexture = false;
               }
            ...
            else if(_loc12_ == RoomPlaneData.const_340)
            {
               ...
               {
                  _loc13_.color = const_1705;
               }
               else
               {
                  _loc13_.color = const_1669;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1625)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_122,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_340)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this.var_1888 + this.const_2080 && !_loc6_ && !_loc8_)
         {
            return;
         }
         ...
         {
            _loc10_ = 0;
            while(_loc10_ < this.var_380.length)
            {
               _loc11_ = this.var_658[_loc10_];
               _loc12_ = getSprite(_loc11_);
               _loc13_ = this.var_380[_loc10_] as RoomPlane;
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1917)
                  {
                     _loc14_ = uint(_loc13_.color);
                     _loc15_ = uint((_loc14_ & 255) * this.var_2678 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2679 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2681 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1598)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1382 || _loc3_.y != this.var_2333 || _loc3_.z != this.var_2332 || param1.scale != this.var_2329))
            {
               this.var_1382 = _loc3_.x;
               this.var_2333 = _loc3_.y;
               this.var_2332 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1040);
            if(_loc3_ != this.var_2680)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2680 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_868));
            if(_loc4_ != this.var_1224)
            {
               this.var_1224 = _loc4_;
               this.var_2678 = this.var_1224 & 255;
               this.var_2679 = this.var_1224 >> 8 & 255;
               this.var_2681 = this.var_1224 >> 16 & 255;
               _loc2_ = true;
            }
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_177 != param1.getUpdateID())
         {
            ...
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_883);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_906);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_872));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_796));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_738));
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < this.var_131.length)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.type == RoomPlane.const_210 && param1 != null)
               {
                  _loc5_.id = param1;
               }
               else if(_loc5_.type == RoomPlane.const_122 && param2 != null)
               {
                  _loc5_.id = param2;
               }
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_380;
         if(this.var_380.length == 0)
         {
            _loc6_ = this.var_131;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_380.length > 0;
         var _loc9_:int = 0;
               ...
               if(_loc12_ != null)
               {
                  if(_loc12_.update(param1,_loc5_))
                  {
                     if(_loc12_.visible)
                     {
                        ...
                        if(_loc12_.type != RoomPlane.const_210)
                        {
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1584;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_531.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_531.maskCount)
         {
            _loc10_ = this.var_531.getMaskType(_loc8_);
            _loc11_ = this.var_531.getMaskLocation(_loc8_);
            _loc12_ = this.var_531.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_131.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_122 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_122 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_265)
                              {
