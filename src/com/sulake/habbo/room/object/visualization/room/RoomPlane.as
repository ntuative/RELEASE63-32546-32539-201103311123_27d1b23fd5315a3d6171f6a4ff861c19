package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      public static const const_1673:int = 0;
      ...
      private var var_1027:IPlaneRasterizer = null;
      
      private var var_838:PlaneMaskManager = null;
      ...
      private var var_234:BitmapData = null;
      ...
      private var var_825:Boolean = true;
      ...
      {
         return this._isVisible && this.var_825;
      }
      ...
      public function copyBitmapData(param1:BitmapData) : BitmapData
      {
         if(this.visible)
         {
            if(this._bitmapData != null && param1 != null)
            {
               ...
               {
                  param1.copyPixels(this._bitmapData,this._bitmapData.rect,const_631);
                  return param1;
               }
            }
         }
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_1027.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_825 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_393))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         {
            _loc5_ = this.var_302.length * param1.scale;
            ...
            if(this.var_1027 != null)
            {
               _loc3_ = this.var_1027.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_2009,this.var_2792,this.var_2791,this.var_2793,this.var_2794,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1598 != geometry.updateId)
         {
            geometryChanged = true;
         }
         if(!geometryChanged || !this.var_825)
         {
            if(!this.visible)
            {
               return false;
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1396.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1396[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originPos = geometry.getScreenPosition(this.var_1104);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_156.z - originZ,this.var_118.z - originZ,this.var_85.z - originZ,this.var_117.z - originZ);
            if(this._type == TYPE_LANDSCAPE)
            {
               relativeDepth += 0.02;
            }
            this.var_2331 = relativeDepth;
            this._isVisible = true;
            this.var_1598 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2795);
      ...
      public function addRectangleMask(param1:Number, param2:Number, param3:Number, param4:Number) : Boolean
      {
         ...
         if(this.var_1028)
         {
            _loc5_ = null;
            _loc6_ = 0;
            while(_loc6_ < this.var_394.length)
            {
               _loc5_ = this.var_394[_loc6_] as RoomPlaneRectangleMask;
               if(_loc5_ != null)
               {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_278.length == this.var_1029.length)
         {
            while(_loc1_ < this.var_278.length)
            {
               ...
               {
                  _loc6_ = false;
                  while(_loc2_ < this.var_1029.length)
                  {
                     _loc7_ = this.var_1029[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
         ...
         if(this.var_394.length > this.var_1542.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_1028 || this.var_278.length == 0 && this.var_394.length == 0 && !this.var_393 || this.var_838 == null)
         {
            return;
         }
         ...
         if(this.var_393)
         {
            ...
            _loc9_ = param2.getCoordinatePosition(this.var_591);
            _loc10_ = 0;
            _loc11_ = 0;
            _loc5_ = 0;
            while(_loc5_ < this.var_278.length)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_71.width - this.var_71.width * _loc3_.leftSideLoc / this.var_302.length;
                  _loc11_ = this.var_71.height - this.var_71.height * _loc3_.rightSideLoc / this.var_303.length;
                  _loc12_ = _loc3_.type;
                  this.var_838.updateMask(this.var_71,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  this.var_1029.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < this.var_394.length)
            {
               _loc4_ = this.var_394[_loc6_] as RoomPlaneRectangleMask;
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_71.width - this.var_71.width * _loc4_.leftSideLoc / this.var_302.length;
                  _loc11_ = this.var_71.height - this.var_71.height * _loc4_.rightSideLoc / this.var_303.length;
                  _loc13_ = this.var_71.width * _loc4_.leftSideLength / this.var_302.length;
                  _loc14_ = this.var_71.height * _loc4_.rightSideLength / this.var_303.length;
                  this.var_71.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1542.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_393 = false;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         if(this.var_234 != null && (this.var_234.width != param1.width || this.var_234.height != param1.height))
         {
            this.var_234.dispose();
            this.var_234 = null;
         }
         if(this.var_234 == null)
         {
            this.var_234 = new BitmapData(param1.width,param1.height,true,4294967295);
         }
         this.var_234.copyChannel(param1,param1.rect,const_631,BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_234.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_234,this.var_234.rect,const_631,BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
