package com.sulake.habbo.sound.trax
{
   public class TraxChannelSample
   {
      ...
      private var var_1611:TraxSample = null;
      ...
      public function method_8(param1:Vector.<Number>, param2:int, param3:int) : void
      {
         var _loc4_:Vector.<Number> = this.var_1611.data;
