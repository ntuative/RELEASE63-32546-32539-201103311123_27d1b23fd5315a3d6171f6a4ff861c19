package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager, IUpdateReceiver
   {
      ...
      private static const const_1436:int = 60;
      ...
      private var var_552:Number = 1.0;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null, param4:Boolean = true)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_667,this.onTraxLoadComplete);
      ...
      public function playSound(param1:String) : void
      {
         ...
         if(_loc2_ == null)
         {
            ...
            this.var_1031.add(param1,_loc2_);
         }
         _loc2_.volume = this.var_552;
         _loc2_.play();
      }
      ...
      private function loadSample(param1:int) : void
      {
         ...
         _loc4_.load(_loc3_);
         this.var_673.add(_loc4_,param1);
      }
      ...
      private function createTraxInstance(param1:int, param2:String, param3:Boolean = true) : TraxSequencer
      {
         ...
         var _loc5_:TraxSequencer = new TraxSequencer(param1,_loc4_,this.var_674,events);
         _loc5_.volume = this.var_552;
      ...
      private function validateSampleAvailability(param1:TraxSequencer, param2:Boolean) : void
      {
         ...
         {
            if(this.var_674.getValue(int(_loc4_[_loc6_])) == null)
            {
               if(param2)
               {
      ...
      {
         if(this.var_184 == null || this._connection == null || this._roomEngine == null || this.var_238 != null)
         {
            return;
         }
         this.var_238 = new HabboMusicController(this,events,this._roomEngine.events,this._connection);
      }
      ...
      private function onTraxLoadComplete(param1:Event) : void
      {
         ...
         this.var_238.onSongLoaded(_loc2_.id);
      }
      
      private function ioErrorHandler(param1:Event) : void
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1677,this.var_827));
         this.var_827 = -1;
         this.var_826 = null;
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            this.setHabboToolbarIconState(this.var_552 > 0);
            return;
         }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_552 * 100)));
         }
      }
      ...
      {
         this.var_552 = param1;
         this.var_238.updateVolume(this.var_552);
      ...
      private function setHabboToolbarIconState(param1:Boolean) : void
      {
         ...
         var _loc2_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_88,HabboToolbarIconEnum.SOUNDS);
      ...
      private function processLoadedSample(param1:Sound) : void
      {
         ...
         var _loc5_:* = null;
         if(this.var_673.getValue(param1) != null)
         {
            _loc2_ = this.var_673.remove(param1);
            if(this.var_674.getValue(_loc2_) == null)
            {
               _loc3_ = new ByteArray();
               _loc4_ = param1.length;
               param1.extract(_loc3_,int(_loc4_ * 44.1));
               _loc5_ = new TraxSample(_loc3_,_loc2_);
               this.var_674.add(_loc2_,_loc5_);
            }
         }
      }
      ...
      private function processLoadedSamples() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         if(this.var_1273.length > 0)
         {
            _loc1_ = getTimer();
            _loc2_ = _loc1_;
            while(_loc2_ - _loc1_ < const_1436 && this.var_1273.length > 0)
            {
               _loc3_ = this.var_1273.splice(0,1)[0];
               this.processLoadedSample(_loc3_);
               _loc2_ = getTimer();
            }
            if(this.var_673.length == 0 && this.var_827 != -1)
            {
               this.var_826.ready = true;
               _loc4_ = this.var_827;
               this.var_827 = -1;
               this.var_826 = null;
               events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_667,_loc4_));
            }
         }
      }
      ...
      private function loadNextSong() : void
      {
         var _loc1_:int = 0;
         var _loc2_:* = null;
         if(this.var_826 == null && this.var_1272.length > 0)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc2_.ready)
               {
                  events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_667,_loc1_));
               }
               else
               {
                  this.var_826 = _loc2_;
