package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      {
         this.var_342 = this._defaultViewId;
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201103311118));
         this.var_181 = param5;
         this.var_112 = new Map();
         this.var_112.add(HabboHelpViewEnum.const_1492,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_112.add(HabboHelpViewEnum.const_174,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_112.add(HabboHelpViewEnum.const_579,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_112.add(HabboHelpViewEnum.const_316,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_112.add(HabboHelpViewEnum.const_267,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_112.add(HabboHelpViewEnum.const_376,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_112.add(HabboHelpViewEnum.const_830,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_112.add(HabboHelpViewEnum.const_221,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_112.add(HabboHelpViewEnum.const_1213,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_112.add(HabboHelpViewEnum.const_1145,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_112.add(HabboHelpViewEnum.const_788,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_483.length == 0 || param1 != this.var_342)
            {
               this.var_483.push(this.var_342);
            }
         }
         this.var_342 = param1;
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + this.var_342);
            return;
         }
         ...
         if(_loc3_)
         {
            ...
            {
               this.var_181.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_54,HabboToolbarIconEnum.HELP,this._window));
            }
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_221:
               this.showUI(HabboHelpViewEnum.const_221);
               break;
            case CallForHelpResultEnum.const_1131:
               this.showUI(HabboHelpViewEnum.const_1145);
               break;
            case CallForHelpResultEnum.const_1133:
               this.showUI(HabboHelpViewEnum.const_1213);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_112.getValue(HabboHelpViewEnum.const_174) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_524));
      }
      ...
      {
         return this.var_112.getValue(this.var_342);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2176 = this._window.width - _loc3_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2174;
         this._window.width = _loc1_.width + this.var_2176;
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_342 == HabboHelpViewEnum.const_174)
         {
            return;
         }
         if(this.var_576.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_576.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_576.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_341.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_576[1],this.var_576[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_576[0],this.var_576[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_342 == HabboHelpViewEnum.const_174 || this.var_483.length == 0)
         {
            return;
         }
         if(this.var_341 == null)
         {
            ...
            this.var_341 = this._windowManager.buildFromXML(XML(_loc2_.content)) as IWindowContainer;
            _loc3_ = this.var_341.findChildByName("back_image");
            if(_loc3_ != null)
            {
            ...
            _loc4_ = this.var_341.findChildByName("back_text");
            if(_loc4_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_341 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_341 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_341 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
