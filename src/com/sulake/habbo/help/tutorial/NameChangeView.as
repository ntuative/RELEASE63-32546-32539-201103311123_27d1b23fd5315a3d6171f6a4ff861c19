package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1388:uint = 13232628;
      
      private static var var_1703:uint = 11129827;
      ...
      private var var_1705:IWindowContainer;
      ...
      private var var_1122:NameSuggestionListRenderer;
      ...
      {
         return TutorialUI.const_292;
      }
      
      public function set checkedName(param1:String) : void
      {
         this.var_504 = param1;
         if(this.var_1704 == this.var_504)
         {
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1705 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_739)
         {
            this.var_739 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_739)
            {
               return;
            }
            this._window.content.addChild(this.var_739);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_738)
         {
            this.var_738 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_738)
            {
               return;
            }
            this._window.content.addChild(this.var_738);
         }
         this._window.caption = this._controller.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_738.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_504;
         }
         this.showView(this.var_738);
      }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            case ChangeUserNameResultMessageEvent.var_847:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_846:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_850:
               break;
            case ChangeUserNameResultMessageEvent.var_848:
            ...
            case ChangeUserNameResultMessageEvent.var_851:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_1046:
               _loc4_.text = this._controller.localization.getKey("help.tutorial.name.change_not_allowed");
               break;
            case ChangeUserNameResultMessageEvent.var_1047:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1047 || param1 == ChangeUserNameResultMessageEvent.var_1046)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1122 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1122.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1388;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "header_button_close":
               this._controller.showView(TutorialUI.const_94);
         }
      }
