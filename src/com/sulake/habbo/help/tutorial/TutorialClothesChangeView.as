package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialClothesChangeView implements ITutorialUIView
   {
      ...
      public function TutorialClothesChangeView(param1:IItemListWindow, param2:TutorialUI)
      {
         ...
         this.var_35.help.toolbar.events.addEventListener(HabboToolbarShowMenuEvent.const_54,this.onShowMenuEvent);
      ...
      {
         return TutorialUI.const_398;
      }
      
      public function dispose() : void
      {
         this.setToolbarIconHighlight(false);
         this.var_35.help.toolbar.events.removeEventListener(HabboToolbarShowMenuEvent.const_54,this.onShowMenuEvent);
      }
      ...
      private function onShowMenuEvent(param1:HabboToolbarShowMenuEvent) : void
      {
         if(param1.menuId == HabboToolbarIconEnum.MEMENU && param1.type == HabboToolbarShowMenuEvent.const_54)
         {
            ...
            this.var_35.help.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_459));
         }
      }
      
      public function setToolbarIconHighlight(param1:Boolean) : void
      {
         var _loc2_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_88,HabboToolbarIconEnum.MEMENU);
         if(param1)
         {
      ...
      private function showToolbarIconHighlightArrow() : void
      {
         ...
         this.var_740 = this.var_35.buildXmlWindow("tutorial_arrow") as IWindowContainer;
         ...
         this.var_35.help.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_54,HabboToolbarIconEnum.MEMENU_ARROW,this.var_740));
      }
