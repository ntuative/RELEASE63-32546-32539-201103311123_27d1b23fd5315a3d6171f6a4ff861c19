package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_430:IRoomSettingsCtrlOwner;
      ...
      private var var_1114:TextFieldManager;
      
      private var var_1112:ICheckBoxWindow;
      
      private var var_1117:ICheckBoxWindow;
      
      private var var_1116:ICheckBoxWindow;
      
      private var var_593:ICheckBoxWindow;
      
      private var var_1700:IWindowContainer;
      ...
      private var var_2357:ITextWindow;
      
      private var var_2356:ITextWindow;
      ...
      {
         this.var_351 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_351));
         if(this.var_1115 != null)
         {
            this.var_1115.visible = false;
         }
      }
      
      public function onRoomSettings(param1:RoomSettingsData) : void
      {
         if(param1.roomId != this.var_351)
         {
            return;
         }
         this.var_75 = param1;
         this._active = true;
         this.var_1701 = true;
         this.var_430.roomSettingsRefreshNeeded();
      }
      ...
      {
         if(param1 != this.var_351 || this.var_1120 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1120 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1713)
         {
            this.var_737.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1717)
         {
            this.var_737.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1480)
         {
            this.var_1119.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1746)
         {
            ...
            this.setTagError(this.var_903,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1741)
         {
            ...
            this.setTagError(this.var_903,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1465)
         {
            this.var_905.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_737.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_537,this.onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_801,this.onDoorModePasswordUnselect);
         ...
         this.var_737 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1119 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_904 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_903 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_905 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1114 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1112 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1117 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1116 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_593 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1700 = IWindowContainer(this._window.findChildByName("header_container"));
         ...
         this.var_1113 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1702 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         ...
         this.var_1115 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_2357 = ITextWindow(this._window.findChildByName("basic_caption"));
         this.var_2356 = ITextWindow(this._window.findChildByName("advanced_caption"));
         this.var_1385 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1385.mouseThreshold = 0;
         this.var_1385.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1115.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1700.visible = this._inRoom;
         this.var_1702.visible = this._inRoom;
         this.var_2356.visible = this.var_503;
         this.var_2357.visible = !this.var_503;
         if(this.var_503)
         {
            this.var_1113.visible = true;
            this.var_1387.visible = false;
            this.refreshFlatControllers();
            this.var_1113.height = Util.getLowestPoint(this.var_1113) + 4;
         }
         else
         {
            this.populateForm();
         ...
         this.var_1385.text = !!this.var_503 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1700.name,this.var_1386.name,this.var_1118.name,this.var_1113.name,this.var_1387.name,this.var_1702.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_737.setText(_loc1_.name);
         this.var_1119.setText(_loc1_.description);
         this.var_905.setText("");
         this.var_1114.setText("");
         ...
         {
            case RoomSettingsData.const_202:
         ...
         this.changePasswordField(_loc1_.doorMode == RoomSettingsData.const_120);
         Logger.log("CATEGORY ID: " + _loc1_.categoryId);
         this.setCategorySelection(_loc1_.categoryId);
         this.refreshMaxVisitors(_loc1_);
         this.setTag(this.var_904,_loc1_.tags[0]);
         this.setTag(this.var_903,_loc1_.tags[1]);
         if(this.var_1112)
         {
            if(_loc1_.allowPets)
            {
               this.var_1112.select();
            }
            else
            {
               this.var_1112.unselect();
            }
         }
         if(this.var_1117)
         {
            ...
            {
               this.var_1117.select();
            }
            else
            {
               this.var_1117.unselect();
            }
         }
         if(this.var_1116)
         {
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_737.getText();
         _loc2_.description = this.var_1119.getText();
         var _loc3_:ISelectorWindow = this._window.findChildByName("doormode") as ISelectorWindow;
         var _loc4_:IWindow = _loc3_.getSelected();
         switch(_loc4_.name)
         {
            case "doormode_doorbell":
               _loc2_.doorMode = RoomSettingsFlatInfo.const_202;
               break;
         ...
         {
            _loc8_ = this.var_905.getText();
            _loc9_ = this.var_1114.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_905.clearErrors();
               this.var_1114.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1112.isSelected;
         _loc2_.allowFoodConsume = this.var_1117.isSelected;
         _loc2_.allowWalkThrough = this.var_1116.isSelected;
         _loc2_.hideWalls = this.var_593.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_904,_loc2_.tags);
         this.addTag(this.var_903,_loc2_.tags);
         this.clearErrors();
         this.var_1120 = _loc2_.roomId;
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_351);
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_75.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_351]);
         _loc2_.show();
      }
      ...
      private function onConfirmRoomDelete(param1:WindowMouseEvent, param2:int) : void
      {
         ...
         this._navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_141,HabboToolbarIconEnum.ROOMINFO));
      }
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_73,HabboWindowStyle.const_32,HabboWindowParam.const_60,new Rectangle(0,0,100,20)));
      }
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_351));
      }
