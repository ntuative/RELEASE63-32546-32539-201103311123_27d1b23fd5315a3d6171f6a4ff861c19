package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1291:TextFieldManager;
      
      private var var_44:Array;
      
      private var var_1292:RoomLayout;
      
      private var var_682:Timer;
      
      private var var_2038:Boolean = true;
      
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         this._navigator = param1;
         this.var_682 = new Timer(100);
         this.var_682.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
      ...
      public function dispose() : void
      {
         if(this.var_682)
         {
            this.var_682.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_682.reset();
            this.var_682 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1292.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_2038 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_2038 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_195 = IWindowContainer(this._navigator.getXmlWindow("roc_create_room"));
         this.var_62 = IItemListWindow(this.var_195.findChildByName("item_list"));
         ...
         this.var_1291 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_195.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
         var _loc4_:Rectangle = Util.getLocationRelativeTo(this.var_195.desktop,this.var_195.width,this.var_195.height);
         this.var_195.x = _loc4_.x;
         this.var_195.y = _loc4_.y;
      }
      
      public function refresh() : void
      {
         this.var_1291.goBackToInitialState();
         this.var_1291.input.textBackgroundColor = 4294967295;
         this.var_1292 = this.var_44[0];
         this.refreshRoomThumbnails();
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_73,HabboWindowStyle.const_32,HabboWindowParam.const_60,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1291.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      
      private function getCreateButton() : IButtonWindow
      {
         return IButtonWindow(this.var_195.findChildByName("create_button"));
      }
      
      private function getCancelButton() : IButtonWindow
      {
         return IButtonWindow(this.var_195.findChildByName("back_button"));
      }
      ...
      {
         var _loc2_:String = this.var_1291.getText();
         var _loc3_:String = "model_" + this.var_1292.name;
