package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1497:CutToWidth = new CutToWidth();
      
      private static var var_1496:CutToHeight = new CutToHeight();
      ...
      public static function cutTextToWidth(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1497.beforeSearch(param2,param1,param3);
         binarySearch(var_1497,param2.length - 1);
      }
      ...
      public static function cutTextToHeight(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1496.beforeSearch(param2,param1,param3);
         binarySearch(var_1496,param2.length - 1);
      }
