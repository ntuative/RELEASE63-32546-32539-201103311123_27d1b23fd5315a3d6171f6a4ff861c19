   ...
   public class RoomQueueStatusMessageParser implements IMessageParser
   {
      ...
      public function parse(param1:IMessageDataWrapper) : Boolean
      {
         ...
         while(_loc5_ < _loc2_)
         {
            ...
            this.var_887.add(_loc4_.target,_loc4_);
            _loc5_++;
         }
         return true;
      }
      ...
      {
         return this.var_887.getKeys();
      }
      
      public function method_10(param1:int) : RoomQueueSet
      {
         return this.var_887.getValue(param1) as RoomQueueSet;
      }
   }
}
