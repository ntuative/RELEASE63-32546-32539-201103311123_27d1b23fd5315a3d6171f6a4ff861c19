package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_519:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_162.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_131,HabboWindowStyle.const_43,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1773,"/");
         if(_loc5_ != null)
         {
         ...
         if(_loc8_)
         {
            ...
            {
               if(this.var_162.habboConfiguration.getKey("use.sso","false") == "com.sulake.room.object.logic")
               {
                  _loc8_.select();
               }
            }
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1773,"/");
         ...
         {
            dispatchEvent(new Event(const_519));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_134.removeEventListener(SSOTicket.const_419,this.onParsedTicketSuccess);
            this.var_134.removeEventListener(SSOTicket.const_297,this.onParsedTicketFailure);
            this.var_134 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_134 = new SSOTicket(this.var_162.assets,_loc3_,_loc2_,param1);
         this.var_134.addEventListener(SSOTicket.const_419,this.onParsedTicketSuccess);
         this.var_134.addEventListener(SSOTicket.const_297,this.onParsedTicketFailure);
      }
      
      private function onParsedTicketSuccess(param1:Event) : void
      {
         Logger.log("Got ticket: " + this.var_134.ticket);
         Logger.log("Has Facebook: " + this.var_134.isFacebookUser);
         if(this.var_134.isFacebookUser)
         {
            this.var_162.habboConfiguration.setKey("facebook.user","1");
         }
         this.var_162.flashClientUrl = this.var_134.flashClientUrl;
         this.var_162.ssoTicket = this.var_134.ticket;
         this.var_134.removeEventListener(SSOTicket.const_419,this.onParsedTicketSuccess);
         this.var_134.removeEventListener(SSOTicket.const_297,this.onParsedTicketFailure);
         this.var_134 = null;
         dispatchEvent(new Event(const_519));
