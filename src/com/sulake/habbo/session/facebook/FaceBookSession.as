package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_956:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1291:String = "sendAccessTokenToServer";
      
      private static const const_1292:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1291,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1292,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_956);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_956);
         }
      }
