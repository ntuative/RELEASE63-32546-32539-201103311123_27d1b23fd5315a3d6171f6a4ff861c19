package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1479:int = 2;
      ...
      private var var_1866:TriggerConfs;
      
      private var var_1865:ActionTypes;
      
      private var var_1864:ConditionTypes;
      ...
      private var var_129:UserDefinedRoomEventsHelp;
      
      private var var_1205:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1866 = new TriggerConfs();
         this.var_1865 = new ActionTypes();
         this.var_1864 = new ConditionTypes();
         this.var_266 = new Dictionary();
         super();
         this.var_81 = param1;
         this.var_784 = new RoomObjectHightLighter(param1);
         this.var_129 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1205 = new SliderWindowController(this.var_81,IWindowContainer(this.find(this.var_51,"delay_slider_container")),this.var_81.assets,0,20,1);
         this.var_1205.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1205.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_784.hideAll(this.var_266);
         }
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1205.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_129.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = this.var_36.stuffTypeSelectionCode < 1 ? int(var_1479) : int(this.var_36.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = (this.var_36.stuffTypeSelectionCode + 1) % (var_1479 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1866);
         this.refreshConfigureElement(this.var_1865);
         this.refreshConfigureElement(this.var_1864);
