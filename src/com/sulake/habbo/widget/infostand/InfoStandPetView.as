package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private var var_102:IBorderWindow;
      ...
      private const const_2067:int = 152;
      
      private const const_2064:int = 16;
      
      private const const_1364:int = 4;
      
      private const const_2065:uint = 14342874;
      
      private const const_2070:uint = 3815994;
      
      private const const_2073:uint = 2085362;
      
      private const const_2071:uint = 39616;
      
      private const const_2066:uint = 10513106;
      
      private const const_2074:uint = 8734654;
      
      private const const_2069:uint = 9094430;
      
      private const const_2068:uint = 6200576;
      
      private const const_2072:String = "happiness";
      
      private const const_2075:String = "experience";
      
      private const const_2063:String = "energy";
      ...
      {
         if(this.var_53 == null || this.var_102 == null || this.var_68 == null)
         {
            return;
         }
         ...
         this.var_102.height = this.var_53.height + 20;
         this._window.width = Math.max(this.var_102.width,this.var_68.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_102.width < this.var_68.width)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_2072,param1.nutrition,param1.nutritionMax,this.const_2071,this.const_2073);
         this.updateStateElement(this.const_2075,param1.experience,param1.experienceMax,this.const_2074,this.const_2066);
         this.updateStateElement(this.const_2063,param1.energy,param1.energyMax,this.const_2068,this.const_2069);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(this.const_2067,this.const_2064,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),this.const_2065);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,this.const_2070);
         var _loc9_:Rectangle = new Rectangle(1,1 + this.const_1364,_loc7_.width - 2,_loc7_.height - 2 - this.const_1364);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,this.const_1364);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_520) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_102 = this._window.getListItemByName("info_border") as IBorderWindow;
         if(this.var_102 != null)
         {
            this.var_53 = this.var_102.findChildByName("infostand_element_list") as IItemListWindow;
         }
         this._window.name = param1;
         this._widget.mainContainer.addChild(this._window);
         var _loc3_:IWindow = this.var_102.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         var _loc6_:IBitmapWrapperWindow = this.var_102.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
         ...
         var _loc7_:IBitmapWrapperWindow = this.var_102.findChildByName("status_happiness_icon") as IBitmapWrapperWindow;
         if(_loc7_ != null)
         {
         ...
         var _loc8_:IBitmapWrapperWindow = this.var_102.findChildByName("status_experience_icon") as IBitmapWrapperWindow;
         if(_loc8_ != null)
         {
         ...
         var _loc9_:IBitmapWrapperWindow = this.var_102.findChildByName("status_energy_icon") as IBitmapWrapperWindow;
         if(_loc9_ != null)
         {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_205 && this.var_205.getPetId() == this.var_520)
               {
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1733,true);
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_523,this._widget.petData.ownerId);
