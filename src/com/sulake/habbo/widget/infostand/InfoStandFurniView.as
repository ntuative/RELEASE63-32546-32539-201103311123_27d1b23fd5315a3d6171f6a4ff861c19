package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      protected var var_102:IBorderWindow;
      ...
      protected function createWindow(param1:String) : void
      {
         ...
         this.var_467 = this.var_102.findChildByTag("catalog");
         if(this.var_467 != null)
         {
            this.var_467.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onCatalogButtonClicked);
         }
      }
      ...
      {
         if(this._widget == null || this.var_102 == null)
         {
            return;
         }
         var _loc2_:IWindow = this.var_102.findChildByName("furni_details_spacer");
         if(_loc2_ != null)
         {
            _loc2_.visible = param1;
         }
         var _loc3_:IWindow = this.var_102.findChildByName("furni_details_text") as ITextWindow;
         if(_loc3_ != null)
         {
      ...
      private function showCatalogButton(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_53.addListItem(this.var_467);
            }
            this.var_467.visible = param1;
         }
         else
         {
            this.var_53.removeListItem(this.var_467);
         }
      }
   }
}
