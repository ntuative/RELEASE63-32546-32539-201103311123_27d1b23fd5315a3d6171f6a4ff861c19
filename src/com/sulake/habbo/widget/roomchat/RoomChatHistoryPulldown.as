package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      public static const const_1008:int = 3;
      
      public static const const_512:int = 2;
      ...
      private static const const_970:int = 150;
      
      private static const const_969:int = 250;
      ...
      private var var_2458:BitmapData;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_40 = param3;
         this.var_2460 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_1772 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2458 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_1774 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_1773 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2459 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2456 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_76 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_286,HabboWindowStyle.const_32,HabboWindowParam.const_60,new Rectangle(0,0,param3.width,param3.height - const_84),null,0,0) as IBitmapWrapperWindow;
         this.var_40.addChild(this.var_76);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_73,HabboWindowStyle.const_32,0 | 0,new Rectangle(0,this.var_40.height - const_84,param3.width,const_84),null,0) as IWindowContainer;
         this.var_40.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_567,HabboWindowStyle.const_43,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_84),null,0) as IRegionWindow;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_512:
               this.var_76.blend += param1 / const_969;
               this._window.blend += param1 / const_969;
               ...
               break;
            case const_1008:
               this.var_76.blend -= param1 / const_970;
               this._window.blend -= param1 / const_970;
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         {
            this._window.x = 0;
            this._window.y = this.var_40.height - const_84;
            this._window.width = this.var_40.width;
         }
         if(this._region != null)
         {
            this._region.x = 0;
            this._region.y = this.var_40.height - const_84;
            this._region.width = this.var_40.width - this.var_2455;
         }
         if(this.var_76 != null)
         {
            this.var_76.rectangle = this.var_40.rectangle;
            this.var_76.height -= const_84;
         }
         this.buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2457 == this._window.width)
         {
            return;
         }
         this.var_2457 = this._window.width;
         ...
         {
            _loc5_.bitmap = this.var_2458;
            _loc5_.disposesBitmap = false;
            _loc2_.bitmap = this.var_1774;
            _loc2_.disposesBitmap = false;
            this.var_2455 = this._window.width - _loc2_.x;
         }
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_2460,_loc7_);
            ...
            if(_loc3_.width > 0 && _loc3_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1772,_loc8_);
            ...
            if(_loc4_.width > 0 && _loc4_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1772,_loc9_);
         ...
         this.var_76.bitmap = this.var_2456;
