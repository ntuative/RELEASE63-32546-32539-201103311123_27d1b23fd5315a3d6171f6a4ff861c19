package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1791:int = 3;
      
      private const const_1790:int = 4;
      ...
      private const const_2090:int = 4;
      
      private const const_2085:int = 5;
      
      private const const_1795:String = "deco_img";
      
      private const const_1792:String = "dialog_bg";
      
      private const const_2086:String = "%campaign%_dialog_bg.png";
      
      private const const_345:String = "%campaign%_gift_package.png";
      
      private const const_2087:String = "%campaign%_gift_content.png";
      
      private const const_2089:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboInventory)
      {
         ...
         this.var_1510 = this.var_163.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1510 += "Viral/";
      }
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1507.length)
         {
            _loc2_ = this.var_1507.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_163 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_492,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_863,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_749,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_492,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_492:
               _loc2_ = this.const_1793;
               this._shareId = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_749:
               ...
               {
                  _loc2_ = this.const_1790;
               }
               this._shareId = null;
               this.var_1508 = param1.itemCategory;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_863:
               _loc2_ = this.const_1796;
               this.var_383 = param1.objectId;
         ...
         if(this._window && (this.var_1509 != _loc2_ || _loc3_ != this.var_191))
         {
            this._window.dispose();
            this._window = null;
         }
         this.var_191 = _loc3_;
         this.var_1509 = _loc2_;
         this.mainWindow;
         this.showInterface();
      }
         ...
         if(!this._window)
         {
            switch(this.var_1509)
            {
               ...
               case this.const_1796:
                  ...
                  else if(this.var_404 == this.const_2088)
                  {
                  ...
                  else if(this.var_404 == this.const_2082)
                  {
                  ...
                  else if(this.var_404 == this.const_2084)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                  ...
                  else if(this.var_404 == this.const_2090)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_191,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_404 == this.const_2085)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
            ...
            _loc5_ = this.const_2086.replace("%campaign%",this.var_191);
            this.setDecoImage(_loc5_,this.const_1792);
      ...
      private function onPostButton(param1:WindowEvent) : void
      {
         ...
         var _loc4_:String = this.var_163.getKey("viral.furni.post_type","feed");
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(this._inventory)
         {
            if(this.var_1508 != 0)
            {
               this._inventory.toggleInventoryPage(this.var_1508 == 1 ? "null" : InventoryCategory.const_154);
            }
         }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_905,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1507.push(new ImageDownloader(this,_assets,this.var_191,this.var_1510,param1,param2));
            return;
         }
