package com.sulake.habbo.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_639:String = "welcome_gift_email_unverified";
      
      private const const_1029:String = "welcome_gift_email_verified";
      
      private const const_1452:String = "welcome_gift_email_change";
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1289)
         {
            this.setViewState(this.const_1029);
         }
         else
         {
            this.setViewState(this.const_639);
         }
      }
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_639:
               ...
               this._view.findChildByName("edit_text").visible = this.var_2037;
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_30,this.var_2037);
               break;
            case this.const_1029:
      ...
      {
         this.setViewState(this.const_1452);
      }
      
      private function openGift(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage(RoomWidgetFurniActionMessage.const_701,this._furniId,0));
         this.disposeView();
      }
      
      private function cancelEmailChange(param1:WindowMouseEvent) : void
      {
         this.setViewState(!!this.var_1289 ? this.const_1029 : this.const_639);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1561 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1561));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_600,this.updateEventHandler);
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_678,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_600,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_678,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_600:
               this.var_1562 = param1.email;
               this.var_1289 = param1.isVerified;
               this.var_2037 = param1.allowEmailChange;
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1561);
