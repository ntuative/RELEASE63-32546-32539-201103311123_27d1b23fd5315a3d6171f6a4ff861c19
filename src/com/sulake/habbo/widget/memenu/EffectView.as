package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private const const_2091:int = 1000;
      
      private var _container:MeMenuEffectsView;
      
      private var _window:IWindowContainer;
      
      private var var_192:IWidgetAvatarEffect;
      
      private var var_1013:IWindow;
      ...
      {
         super();
         this.var_212 = new Timer(this.const_2091);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_192.isActive)
         {
            _loc2_ = this.var_192.secondsLeft / Number(this.var_192.duration);
            this.var_1013.width = _loc2_ * this.var_320;
         }
         else
         {
            this.var_1013.width = 0;
            this.var_212.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_804 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_804 == null)
            {
               return;
            }
         ...
         if(!this.var_192.isActive)
         {
            this.var_804.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_804.caption = "${widgets.memenu.effects.active.timeleft}";
         var _loc1_:String = this.var_804.text;
         var _loc2_:int = this.var_192.secondsLeft;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var _loc7_:* = null;
         var _loc3_:String = "";
         if(this.var_192.isInUse)
         {
            _loc3_ = "memenu_effect_selected";
         }
         else if(this.var_192.isActive)
         {
         ...
         else
         {
            ...
            this.var_1012 = this._window.findChildByName("effect_hilite");
            this.var_1012.visible = false;
         }
         this.setTimeLeft();
         this.var_1013 = this._window.findChildByName("loader_bar");
         if(this.var_1013 != null)
         {
            this.var_320 = this.var_1013.width;
            this.var_212.start();
            this.onUpdate();
         }
         if(this.var_192.icon)
         {
            this.setElementBitmap("effect_icon",this.var_192.icon);
         }
      }
