package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_1025:MeMenuSoundSettingsSlider;
      
      private var var_1998:BitmapData;
      
      private var var_2000:BitmapData;
      
      private var var_1999:BitmapData;
      ...
      {
         this.var_552 = param1.volume;
         if(this.var_1025 != null)
         {
            this.var_1025.setValue(this.var_552);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_1998 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_off_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_2000 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_on_color") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1999 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_on_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1997 = (_loc5_.content as BitmapData).clone();
         }
         this.var_1025 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.setSoundsOffIcon();
         this.setSoundsOnIcon();
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_769));
      }
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_552 == 0)
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1998);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_2000);
         }
      }
      ...
      private function setSoundsOnIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_552 == 1)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1999);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1997);
         }
      }
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_881);
         }
