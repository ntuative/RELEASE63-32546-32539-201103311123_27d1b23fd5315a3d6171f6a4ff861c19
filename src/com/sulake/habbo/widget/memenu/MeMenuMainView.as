package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuMainView implements IMeMenuView
   {
      ...
      public function init(param1:MeMenuWidget, param2:String) : void
      {
         ...
         this.var_160["rooms_icon"] = ["gohome_white","gohome_color"];
         this.var_160["dance_icon"] = ["dance_white","dance_color"];
         this.var_160["clothes_icon"] = ["clothes_white","clothes_color"];
         this.var_160["effects_icon"] = ["effects_white","effects_color"];
         this.var_160["badges_icon"] = ["badges_white","badges_color"];
         this.var_160["wave_icon"] = ["wave_white","wave_color"];
         this.var_160["hc_icon"] = ["_white","_color"];
         this.var_160["settings_icon"] = ["settings_white","settings_color"];
         this.var_160["credits_icon"] = ["credits_white","credits_color"];
         this.var_160["news_icon"] = ["news_white","news_color"];
         this._widget = param1;
      ...
      {
         if(this.var_160[param1] == null)
         {
            return;
         }
         if(param3 != null)
         {
            this.var_160[param1][0] = param3;
         }
         if(param4 != null)
         {
            this.var_160[param1][1] = param4;
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         for(_loc3_ in this.var_160)
         {
            _loc6_ = this.var_160[_loc3_];
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               this._widget.changeView(MeMenuWidget.const_1239);
               break;
            case "wave":
               if(this._widget.hasEffectOn)
               {
            ...
            case "effects":
               ...
               this._widget.changeView(MeMenuWidget.const_785);
               break;
            case "rooms":
               ...
               break;
            case "badges":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_1038));
               this._widget.hide();
               break;
            case "clothes":
               ...
               break;
            case "hc":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1181));
               this._widget.hide();
               break;
            case "settings":
               this._widget.changeView(MeMenuWidget.const_853);
               break;
            case "news":
               ...
               break;
            case "credits":
               _loc4_ = this._widget.config.getKey("client.credits.embed.enabled","false") == "com.sulake.room.object.logic";
               if(false && _loc4_)
               {
