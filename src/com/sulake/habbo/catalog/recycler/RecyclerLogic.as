package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_978:int = 0;
      
      private static const const_431:int = 1;
      
      private static const const_979:int = 2;
      ...
      {
         return this.var_630 != const_978;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1816 != RecyclerStatusMessageEvent.const_1081;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_630 == const_431;
      }
      ...
      {
         this.var_630 = const_979;
         this.var_124 = new Array(const_197);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         {
            case RecyclerStatusMessageEvent.const_1507:
               this.var_630 = const_431;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1081:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1748:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1218:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1600:
      ...
      public function getSlotContent(param1:int) : FurniSlotItem
      {
         ...
         if(param1 >= this.var_124.length)
         {
            return null;
         }
         return this.var_124[param1];
      }
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         {
            oldObjectData = this.var_124[0];
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_197)
            {
               oldObjectData = this.var_124[newSlotId];
         ...
         this.var_124[slotId] = new FurniSlotItem(itemId,category,typeId,xxxExtra);
         this.updateRecyclerSlots();
         this.updateRecyclerButton();
      }
      ...
      public function releaseSlot(param1:int) : void
      {
         ...
         if(this.var_124[param1] == null)
         {
            return;
         }
         if(!this._catalog.returnInventoryFurniFromRecycler(this.var_124[param1].id))
         {
            return;
         }
         this.var_124[param1] = null;
         this.updateRecyclerSlots();
         this.updateRecyclerButton();
      }
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_124.length < const_197)
         {
            return false;
         }
         var _loc1_:int = 0;
