package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_988:String = "bg";
      ...
      {
         this._view.getChildByName(const_988).style = HabboWindowStyle.const_32;
      }
      
      public function deActivate() : void
      {
         this._view.getChildByName(const_988).style = 3;
      }
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_25 && this.var_624 != null && this.var_624 == param2)
         {
            _loc3_ = this.var_260.startDragAndDrop(this);
            if(_loc3_)
            {
               this.var_624 = null;
            }
         ...
         else if(param1.type == WindowMouseEvent.const_246)
         {
            this.var_624 = null;
         }
      }
