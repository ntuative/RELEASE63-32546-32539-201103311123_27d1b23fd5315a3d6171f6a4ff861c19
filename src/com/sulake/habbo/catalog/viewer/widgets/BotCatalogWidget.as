package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class BotCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IAvatarImageListener
   {
      ...
      private var var_374:IGridItem;
      
      public function BotCatalogWidget(param1:IWindowContainer)
      {
         super(param1);
         this.var_1057 = _window.findChildByName("botGrid") as IItemGridWindow;
      ...
      {
         this.var_1522 = param1.botFigureData;
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         var _loc3_:String = this.var_1522.getValue(param1.productContainer.firstProduct.extraParam.toLowerCase());
      ...
      {
         var _loc1_:String = this.var_1522.getValue(this.var_808.productContainer.firstProduct.extraParam.toLowerCase());
         ...
         if(_loc2_)
         {
            ...
            this.setPreviewImage(_loc2_.getImage(AvatarSetType.const_36,true));
            _loc2_.dispose();
         }
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         for each(_loc3_ in page.offers)
         {
            ...
            {
               _loc4_ = this.var_1522.getValue(_loc3_.productContainer.firstProduct.extraParam.toLowerCase());
