package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_917.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_917 = null;
         }
         if(this.var_918 != null)
         {
            this.var_918.removeEventListener(WindowKeyboardEvent.const_205,this.windowKeyEventProcessor);
            this.var_918 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_917 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_917 != null)
         {
            this.var_917.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_918 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_918 != null)
         {
            this.var_918.addEventListener(WindowKeyboardEvent.const_205,this.windowKeyEventProcessor);
         }
         return true;
      }
