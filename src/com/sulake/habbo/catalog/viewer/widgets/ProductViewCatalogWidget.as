package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1940:Point;
      
      private var var_537:IItemGridWindow;
      
      private var var_1515:IScrollbarWindow;
      
      protected var var_2043:XML;
      
      private var var_2728:Array;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1011 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1239 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_86 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1940 = new Point(this.var_86.x,this.var_86.y);
         this.var_537 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1515 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1939 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_537 != null)
         {
            ...
            this.var_537.destroyGridItems();
         }
         if(this.var_1515 != null)
         {
            this.var_1515.visible = false;
         }
         ...
         this.var_1011.text = _loc4_;
         this.var_1239.text = _loc5_;
         this.var_1011.height = this.var_1011.textHeight + 5;
         this.var_1239.y = this.var_1011.y + this.var_1011.height;
         this.var_1239.height = Math.max(130,this.var_1239.textHeight + 5);
         ...
         else
         {
            ...
            {
               case Offer.const_581:
                  _loc6_ = this.var_1939.clone();
                  if(this.var_537 != null)
                  {
                     this.var_537.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_537,this.var_1515,this.var_2043);
                     this.var_537.scrollV = 0;
                  }
                  break;
               case Offer.const_584:
               case Offer.const_493:
                  ...
                  switch(_loc8_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_181:
                        ...
                        _loc6_ = new BitmapData(this.var_86.width,this.var_86.height,false,_loc13_);
                        _loc14_ = null;
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_308,AvatarAction.const_445);
                              _loc16_.appendAction(AvatarAction.const_333,_loc8_.productClassId);
                              _loc16_.endActionAppends();
                              _loc16_.updateAnimationByFrames(1);
                              _loc16_.updateAnimationByFrames(1);
                              _loc14_ = _loc16_.getImage(AvatarSetType.const_36,true);
      ...
      private function addEffectSprites(param1:BitmapData, param2:IAvatarImage, param3:Point, param4:Point, param5:Boolean = true) : void
      {
         ...
         {
            _loc7_ = _window.getChildIndex(this.var_86);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2728)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2728 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_86 != null && true)
         {
            ...
            _loc4_ = new Point((this.var_86.width - param1.width) / 2,(this.var_86.height - param1.height) / 2);
            this.var_86.bitmap.copyPixels(param1,param1.rect,_loc4_,null,null,true);
            this.var_86.invalidate();
            this.var_86.x = this.var_1940.x;
            this.var_86.y = this.var_1940.y;
            if(param3 != null)
            {
               this.var_86.x += param3.x;
               this.var_86.y += param3.y;
            }
         }
         if(param2)
         {
