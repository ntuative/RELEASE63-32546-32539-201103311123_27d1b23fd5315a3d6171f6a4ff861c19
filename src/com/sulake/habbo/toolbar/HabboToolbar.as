package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_1368:LogoutController;
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_316.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(this.onAuthenticationOK));
      }
      ...
      {
         this._view = new ToolbarView(this._windowManager,this._assetLibrary,this.var_316.getHabboMainConnection(null),events,this._config);
         if(this._config && this._config.getKey("client.logout.enabled","false") == "com.sulake.room.object.logic")
         {
            this.var_1368 = new LogoutController(this._windowManager,this._assetLibrary,events);
         }
         if(this._view == null)
         {
            return;
         }
         events.addEventListener(HabboToolbarSetIconEvent.const_136,this.onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_1150,this.onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_141,this.onRemoveToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_88,this.onSetToolbarIconStateEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_54,this.onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_470,this.onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1147,this.onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1205,this.onHideWindowEvent);
         this._state = true;
      ...
      private function onAnimateWindowEvent(param1:HabboToolbarShowMenuEvent) : void
      {
         ...
         {
            if(param1.type == HabboToolbarShowMenuEvent.const_54)
            {
