package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_217:Boolean = true;
      
      private static const const_1341:Number = 25;
      
      private static const const_1342:Number = 90;
      
      private static const const_984:int = 50;
      
      private static const const_1363:int = 50;
       
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1462:ToolbarView;
      
      private var var_773:Timer;
      
      private var var_371:Array;
      
      private var _itemList:Object;
      
      private var var_632:Object;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         this.var_632 = new Object();
         this.var_634 = new Array();
         this.var_633 = new Array();
         super();
         this._windowManager = param1;
         this.var_1462 = param2;
         this.var_773 = new Timer(const_1341);
         this.var_773.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.repositionWindow(this.var_371[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_984 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_984 || param1.desktop.height - param1.y < const_1363;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1462.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
            ...
            this.var_371.push(_loc3_.menuId);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Point = this.var_1462.getIconLoc(param1.iconId);
      ...
      {
         return this.var_634[this.var_633.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_633[this.var_634.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = this.var_633.indexOf(param2);
         if(_loc3_ > -1)
         {
            this.var_633.splice(_loc3_,1);
            this.var_634.splice(_loc3_,1);
         }
         this.var_634.push(param1.name);
         this.var_633.push(param2);
         param1.addEventListener(WindowEvent.const_410,this.windowEventListener);
         param1.addEventListener(WindowEvent.const_239,this.windowEventListener);
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(this.var_632[_loc3_] == null)
            {
               this.var_632[_loc3_] = new Array();
            }
            if(this.var_632[_loc3_].indexOf(param1) < 0)
            {
               this.var_632[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      public function removeItem(param1:String) : void
      {
         if(this.var_371.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               this.var_371.splice(this.var_371.indexOf(param1),1);
            }
         }
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(this.var_634[_loc2_] == param1.window.name)
            {
               _loc3_ = this.var_633[_loc2_];
               if(this.var_632[_loc3_] != null)
               {
                  _loc4_ = 0;
                  while(_loc4_ < this.var_632[_loc3_].length)
                  {
                     this.repositionWindow(this.var_632[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
      ...
      private function animationUpdate(param1:TimerEvent) : void
      {
         ...
         var _loc7_:int = 0;
         while(_loc7_ < this.var_371.length)
         {
            _loc2_ = this._itemList[this.var_371[_loc7_]];
            if(_loc2_.active)
            {
