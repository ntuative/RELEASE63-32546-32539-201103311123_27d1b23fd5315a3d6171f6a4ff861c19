package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_549:String = "LEFT";
      
      private var var_173:Number = 50;
      
      private var var_1269:Boolean = true;
      
      private var var_1268:Number = 1;
      
      private var var_1539:Number = 0;
      
      private var var_2001:Number = 15;
      
      private var var_2002:Number = 5;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IConnection, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.var_173 = this._window.width;
         this.var_233 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_73,HabboWindowStyle.const_1197,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         this._window.tags.push("habbo_extrabar");
         if(param5.getKey("friendbar.enabled") == "com.sulake.room.object.logic")
         {
         ...
         this.var_1269 = String(_loc8_.relocate_by_drag.@state) == "com.sulake.room.object.logic";
         if(this.var_1269)
         {
         ...
         this.var_1268 = _loc8_.toolbar.@margin_top;
         this.var_1539 = _loc8_.toolbar.@margin_bottom;
         this.var_2001 = _loc8_.toolbar.@min_group_margin;
         this.var_2002 = _loc8_.toolbar.@margin_to_extrabar;
         ...
         this.createGroupsFromXmlList(_loc9_,this.var_277,param1,param2,param3,this._window,this.var_308);
         this.createGroupsFromXmlList(_loc10_,this.var_672,param1,param2,param3,this.var_233,this.var_308);
         this.alignWindows();
      }
      ...
      private function createGroupsFromXmlList(param1:XMLList, param2:Array, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IConnection, param6:IWindowContainer, param7:ToolbarBarMenuAnimator) : void
      {
         ...
         while(_loc11_ < param1.length())
         {
            ...
            _loc10_ = new ToolbarIconGroup(param3,param4,param5,_loc11_,this._events,param6,param7,this.var_173);
      ...
      public function dispose() : void
      {
         ...
         while(this.var_672.length > 0)
         {
            _loc1_ = this.var_672.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
         if(this._window != null)
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_173,this.var_549,param3);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,this.var_549);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_173,this.var_549);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_173,this.var_549);
         }
      }
      ...
      {
         this.alignWindows();
         var _loc2_:HabboToolbarEvent = new HabboToolbarEvent(HabboToolbarEvent.const_679);
      ...
      private function alignWindows() : void
      {
         ...
         if(this._window == null || this.var_233 == null)
         {
            return;
         }
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_233.x = this.var_173 + this.var_2002;
               this.var_233.y = 0;
               _loc4_ = this._window.height;
               break;
            case "RIGHT":
               this._window.width = this.var_173;
               this._window.height = _loc1_.height;
               this._window.x = _loc1_.width - this.var_173;
               this._window.y = 0;
               this.var_233.x = 0;
               this.var_233.y = 0;
               _loc4_ = this._window.height;
            ...
            case "TOP":
               ...
               this._window.height = this.var_173;
               this._window.x = 0;
               this._window.y = 0;
               this.var_233.x = 0;
               this.var_233.y = this.var_173 + this.var_2002;
            ...
            case "BOTTOM":
               ...
               this._window.height = this.var_173;
               this._window.x = 0;
               this._window.y = _loc1_.height - this.var_173;
               this.var_233.x = 0;
               this.var_233.y = 0;
               _loc4_ = this._window.width;
         }
         _loc4_ -= this.var_1539;
         _loc4_ -= this.var_1268;
         var _loc5_:* = 0;
         _loc2_ = 0;
         while(_loc2_ < this.var_277.length)
         {
            _loc3_ = this.var_277[_loc2_];
            _loc5_ += _loc3_.iconCount * _loc3_.defaultIconSize;
            _loc2_++;
         }
         var _loc6_:* = 0;
         var _loc7_:Number = this.var_1268;
         var _loc8_:* = 1;
         if(_loc5_ > _loc4_)
         {
         ...
         else
         {
            ...
            if(this.var_277.length > 1)
            {
               ...
               {
                  _loc6_ = Number(Math.max(this.var_2001,(this._window.height - _loc5_ * _loc8_ - this.var_1268 - this.var_1539) / (this.var_277.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this.var_2001,(this._window.width - _loc5_ * _loc8_ - this.var_1268 - this.var_1539) / (this.var_277.length - 1)));
               }
            }
         }
         _loc2_ = 0;
         while(_loc2_ < this.var_277.length)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.orientation = this.var_549;
         ...
         _loc2_ = 0;
         while(_loc2_ < this.var_672.length)
         {
            _loc3_ = this.var_672[_loc2_];
            if(_loc3_ != null)
            {
      ...
      private function onStageMouseMove(param1:MouseEvent) : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_1269 && this.var_1540)
         {
            _loc2_ = this.getTargetOrientationFromXY(param1.stageX,param1.stageY);
            if(_loc2_ != null && _loc2_ != this.var_549)
            {
               this.var_549 = _loc2_;
               this.alignWindows();
               if(this._events != null)
               {
                  _loc3_ = new HabboToolbarEvent(HabboToolbarEvent.const_585);
                  _loc3_.orientation = this.var_549;
      ...
      private function getTargetOrientationFromXY(param1:Number, param2:Number) : String
      {
         ...
         if(param1 >= _loc3_.width - this.var_173)
         {
            return "RIGHT";
         }
         ...
         if(param2 >= _loc3_.height - this.var_173)
         {
            return "BOTTOM";
         }
         return null;
