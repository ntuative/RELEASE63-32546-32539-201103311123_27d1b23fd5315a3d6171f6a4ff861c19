package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_428:uint = 3;
      
      private static const const_1322:uint = 1;
      ...
      private var var_919:IWindowRenderer;
      
      private var var_913:ISkinContainer;
      
      private var var_249:Array;
      
      private var var_1412:IEventDispatcher;
      
      private var var_1139:Boolean = false;
      
      private var var_1740:ProfilerOutput;
      
      private var var_1411:ProfilerAgentTask;
      
      private var var_1413:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_919 = new WindowRenderer(this.var_913);
         this._windowContextArray = new Array(const_428);
         ...
         var _loc6_:int = 0;
         while(_loc6_ < const_428)
         {
            this._windowContextArray[_loc6_] = new WindowContext("layer_" + _loc6_,this.var_919,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this.var_262 = this._windowContextArray[const_1322];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1740)
            {
               this.var_1740 = new ProfilerOutput(context,this,this.var_919);
            }
            this.var_1740.profiler = _loc3_;
            this.var_1411 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1411);
            this.var_1413 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1413);
            this.var_1139 = true;
         }
      }
      ...
      {
         return this.var_262.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_262.getWindowParser().windowToXMLString(param1);
      }
      
      public function getLayoutByTypeAndStyle(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = this.var_249[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? this.var_249[0][param1] as XML : _loc4_;
      }
      ...
      {
         return this._windowContextArray[param1].getDesktopWindow().getChildAt(this.var_262.getDesktopWindow().numChildren - 1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            this.var_1412.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_428 - 1;
            while(_loc2_ >= 0)
            {
         ...
         this.var_1412.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_428)
         {
         ...
         this.var_1412.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1661,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1503,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1456,new Date().getTime().toString());
