package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_2009:int = "M".charCodeAt(0);
      ...
      private var var_1231:BitmapData;
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_948 = param1.gender;
         this.var_834 = param1.online;
         this.var_1677 = param1.followingAllowed && param1.online;
         this.var_617 = param1.figure;
         this.var_1927 = param1.motto;
         this.var_1925 = param1.lastAccess;
         this.var_1565 = param1.categoryId;
         this.var_1926 = param1.realName;
