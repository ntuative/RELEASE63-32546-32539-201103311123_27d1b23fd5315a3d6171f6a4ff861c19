package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1787:String = "no_reqs_info";
      ...
      private var var_1881:IContainerButtonWindow;
      
      private var var_1880:IContainerButtonWindow;
      ...
      {
         this.var_1881 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1880 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1880.procedure = this.onDismissAllButtonClick;
         this.var_1881.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         if(param1.state == FriendRequest.const_167)
         {
         ...
         else if(param1.state == FriendRequest.const_390)
         {
            this._friendList.refreshText(_loc2_,"info_text",true,"${friendlist.request.declined}");
         }
         else if(param1.state == FriendRequest.const_1088)
         {
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         {
            this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_45,param1));
         }
      }
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_390;
         ...
         if(this._friendList && this._friendList.events)
         {
            this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_339,param1));
         }
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_370 && _loc4_.state != FriendRequest.const_390)
            {
               _loc4_.state = FriendRequest.const_390;
               this.refreshRequestEntry(_loc4_);
               if(this._friendList && this._friendList.events)
               {
                  this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_339,_loc4_.requestId));
               }
            }
         }
         this.refresh();
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in this._friendList.friendRequests.requests)
         {
            if(_loc4_.state != FriendRequest.const_370 && _loc4_.state != FriendRequest.const_390)
            {
               ...
               if(this._friendList && this._friendList.events)
               {
                  this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_45,_loc4_.requestId));
               }
            }
         }
         this._friendList.send(_loc3_);
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1881,_loc1_);
         this.setEnabled(this.var_1880,_loc1_);
      }
