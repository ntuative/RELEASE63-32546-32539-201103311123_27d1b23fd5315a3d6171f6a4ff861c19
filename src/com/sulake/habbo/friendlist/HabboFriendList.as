package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_793:ISessionDataManager;
      
      private var var_2643:FriendListLookAndFeel;
      
      private var var_445:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1899:OpenedToWebPopup;
      
      private var var_2578:int;
      
      var var_103:FriendCategories;
      
      private var var_377:FriendRequests;
      
      private var var_1898:AvatarSearchResults;
      ...
      {
         this.var_2643 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_103 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1898 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_649.stop();
            this.var_649.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_649 = null;
         }
         ...
         if(this.var_139)
         {
            this.var_139.release(new IIDHabboMessenger());
            this.var_139 = null;
         }
         if(this.var_184)
         {
         ...
         if(this.var_1094)
         {
            this.var_1094.release(new IIDAvatarRenderManager());
            this.var_1094 = null;
         }
         ...
         if(this.var_793)
         {
            this.var_793.release(new IIDSessionDataManager());
            this.var_793 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1899 = new OpenedToWebPopup(this);
         }
         this.var_1899.show(x,y);
      }
      ...
      public function openFriendList() : void
      {
         ...
         var _loc1_:FriendListTab = this.tabs.findTab(FriendListTab.const_95);
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_88,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(this.var_377.getCountOfOpenRequests() > 0 ? "2" : "0");
         this.var_181.events.dispatchEvent(_loc1_);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_286,HabboWindowStyle.const_43,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1094.createAvatarImage(param1,AvatarScaleType.const_93,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      public function isEmbeddedMinimailEnabled() : Boolean
      {
         ...
         return _loc1_ == "com.sulake.room.object.logic";
      }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_139 = param2 as IHabboMessenger;
      ...
      {
         this.var_181 = IHabboToolbar(param2) as IHabboToolbar;
      ...
      {
         this.var_793 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_377 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_103.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_103.addCategory(new FriendCategory(FriendCategory.const_1224,this.getText("friendlist.friends")));
         this.var_103.addCategory(new FriendCategory(FriendCategory.const_382,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_103.addFriend(new Friend(_loc4_));
         }
         this.var_445 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_649)
         {
            this.var_649 = new Timer(120000);
            this.var_649.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_649.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         this.var_181.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_136,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_103.findCategory(FriendCategory.const_382);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_445.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_353));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_377.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_377.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_445.findTab(FriendListTab.const_100).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_377.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_445.findTab(FriendListTab.const_100);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1898.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_445.findTab(FriendListTab.const_100);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_793 || !this.var_377)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_793.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_46))
         {
            _loc2_ = this.var_377.vipLimit;
         }
         else if(this.var_793.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_44))
         {
            _loc2_ = this.var_377.clubLimit;
         }
         if(_loc2_ > this.var_377.limit)
         {
            this.var_377.limit = _loc2_;
         }
      }
