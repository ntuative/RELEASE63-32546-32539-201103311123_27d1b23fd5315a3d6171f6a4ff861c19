package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_945:Number = 64;
      
      public static const const_1055:Number = 32;
      ...
      private var var_1974:Number = 1.0;
      
      private var var_1975:Number = 1.0;
      
      private var var_1972:Number = 1.0;
      
      private var var_94:Vector3d;
      
      private var var_390:Vector3d;
      
      private var var_2908:Number = -500.0;
      
      private var var_2909:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1257 = new Vector3d();
         this.var_1974 = 1;
         this.var_1975 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1972 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_1973.assign(this.var_168);
         return this.var_1973;
      }
      
      public function get location() : IVector3d
      {
         this.var_545.assign(this.var_94);
         this.var_545.x *= this.var_461;
         this.var_545.y *= this.var_460;
         this.var_545.z *= this.var_462;
         return this.var_545;
      }
      
      public function get direction() : IVector3d
      {
         this._direction.assign(this.var_390);
         return this._direction;
      }
      
      public function set x_scale(param1:Number) : void
      {
         if(this.var_461 != param1 * this.var_1974)
         {
            this.var_461 = param1 * this.var_1974;
            ++this.var_171;
         }
      }
      ...
      {
         if(this.var_460 != param1 * this.var_1975)
         {
            this.var_460 = param1 * this.var_1975;
            ++this.var_171;
         }
      }
      ...
      {
         if(this.var_462 != param1 * this.var_1972)
         {
            this.var_462 = param1 * this.var_1972;
            ++this.var_171;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_94.x /= this.var_461;
         this.var_94.y /= this.var_460;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_390.x;
         var _loc3_:Number = this.var_390.y;
         var _loc4_:Number = this.var_390.z;
         this.var_390.assign(param1);
         if(this.var_390.x != _loc2_ || this.var_390.y != _loc3_ || this.var_390.z != _loc4_)
         {
            ++this.var_171;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_169.assign(_loc24_);
            this.var_168.assign(_loc25_);
         }
         else
         {
            this._x.assign(_loc18_);
            this.var_169.assign(_loc19_);
            this.var_168.assign(_loc20_);
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_544 != null)
         {
            ...
            this.var_544.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_544.add(_loc3_,_loc4_);
            ++this.var_171;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_544 != null)
         {
            ...
            return this.var_544.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1257.assign(_loc22_);
         }
         else
         {
            this.var_1257.assign(_loc17_);
         }
         ++this.var_171;
      }
      ...
      {
         if(param1 == null || this.var_168 == null)
         {
            return;
         }
         var _loc3_:Vector3d = Vector3d.product(this.var_168,-param2);
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc3_:Number = Vector3d.scalarProjection(param1,this.var_169);
         var _loc4_:Number = Vector3d.scalarProjection(param1,this.var_168);
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_461;
         _loc2_.y *= this.var_460;
         _loc2_.z *= this.var_462;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1257);
         if(_loc3_ < this.var_2908 || _loc3_ > this.var_2909)
         {
            return null;
         }
         var _loc4_:Number = Vector3d.scalarProjection(_loc2_,this._x);
         var _loc5_:Number = -Vector3d.scalarProjection(_loc2_,this.var_169);
         _loc4_ *= this._scale;
         _loc5_ *= this._scale;
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_460;
            _loc2_.z *= this.var_462;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1257);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         _loc7_.add(Vector3d.product(this.var_169,_loc6_));
         var _loc8_:Vector3d = new Vector3d(this.var_94.x * this.var_461,this.var_94.y * this.var_460,this.var_94.z * this.var_462);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_168;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_461,param2.y * this.var_460,param2.z * this.var_462);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_461,param3.y * this.var_460,param3.z * this.var_462);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_461,param4.y * this.var_460,param4.z * this.var_462);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1055;
         }
         else
         {
            this.scale = const_945;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_945;
      }
