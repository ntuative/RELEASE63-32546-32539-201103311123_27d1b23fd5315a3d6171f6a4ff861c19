package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_2933:IRoomContentLoader;
      
      private var var_601:IRoomObjectFactory = null;
      
      private var var_506:IRoomObjectVisualizationFactory = null;
      
      private var _state:int = 0;
      
      private var var_1126:XML = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_603 = [];
         this.var_602 = [];
         events.addEventListener(RoomContentLoadedEvent.const_359,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_594,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_723,this.onContentLoaded);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_119.length;
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
               _loc3_ = this.var_119.getWithIndex(_loc2_) as IRoomInstance;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_601 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_601 == null || this.var_506 == null)
         {
            return;
         }
         this._state = const_1707;
         if(this.var_1126 != null)
         {
            _loc1_ = this.var_1126;
            this.var_1126 = null;
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_603.indexOf(_loc5_) < 0)
            {
               this.var_55.loadObjectContent(_loc5_,events);
               this.var_603.push(_loc5_);
            }
            _loc4_++;
         }
      ...
      {
         var _loc4_:* = null;
         var _loc2_:int = this.var_602.indexOf(param1);
         if(_loc2_ >= 0)
         {
            return;
         }
         this.var_602.push(param1);
         var _loc3_:int = this.var_119.length - 1;
         while(_loc3_ >= 0)
         {
            _loc4_ = this.var_119.getWithIndex(_loc3_) as RoomInstance;
            if(_loc4_ != null)
            {
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         this.var_119.add(String(param1),_loc3_);
         var _loc4_:int = this.var_602.length - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_602[_loc4_];
      ...
      {
         return this.var_119.getValue(param1) as IRoomInstance;
      }
      
      public function disposeRoom(param1:String) : Boolean
      {
         var _loc2_:IRoomInstance = this.var_119.remove(param1) as IRoomInstance;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            return true;
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = this.var_506.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = this.var_506.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_601.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_601 != null)
         {
            return this.var_601.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this._state == const_875)
         {
            return;
         }
         if(this.var_55 == null)
         {
            this._state = const_875;
            return;
         }
         if(this.var_55.getGraphicAssetCollection(param1) != null)
         {
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(this.var_910.indexOf(_loc2_) < 0)
         {
            this.var_910.push(_loc2_);
         }
      }
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         {
            _loc2_ = this.var_910[0];
            this.var_910.splice(0,1);
      ...
      private function updateObjectContents(param1:String) : void
      {
         ...
         if(this.var_55 == null || this.var_506 == null)
         {
            return;
         }
         ...
         var _loc7_:IRoomObjectVisualizationData = this.var_506.getRoomObjectVisualizationData(param1,_loc5_,_loc2_);
         var _loc8_:int = this.var_119.length - 1;
         while(_loc8_ >= 0)
         {
            _loc9_ = this.var_119.getWithIndex(_loc8_) as RoomInstance;
            _loc10_ = this.var_119.getKey(_loc8_);
            if(_loc9_ != null)
            {
               ...
               for each(_loc12_ in _loc11_)
               {
                  ...
                  while(_loc14_ >= 0)
                  {
                     ...
                     if(_loc15_ != null)
                     {
                        _loc16_ = this.var_506.createRoomObjectVisualization(_loc5_);
                        if(_loc16_ != null)
                        {
                           ...
                           else
                           {
                              ...
                              _loc17_ = this.var_601.createRoomObjectLogic(_loc6_);
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:int = this.var_119.length - 1;
         while(_loc2_ >= 0)
         {
            _loc3_ = this.var_119.getWithIndex(_loc2_) as RoomInstance;
            if(_loc3_ != null)
            {
               _loc3_.update();
            }
