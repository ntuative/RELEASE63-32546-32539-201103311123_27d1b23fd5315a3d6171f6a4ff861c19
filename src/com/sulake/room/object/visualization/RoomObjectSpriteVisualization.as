package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      private var var_384:IRoomObject;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_207 != null)
         {
            ...
            {
               _loc1_ = this.var_207[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function set assetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         {
            this.var_792.removeReference();
         }
         this.var_792 = param1;
         if(this.var_792 != null)
         {
            this.var_792.addReference();
         }
      }
      ...
      {
         var _loc2_:* = null;
         while(this.var_207.length > param1)
         {
            _loc2_ = this.var_207[this.var_207.length - 1] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
