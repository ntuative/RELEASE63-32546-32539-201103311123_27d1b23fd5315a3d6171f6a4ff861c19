package com.sulake.room.object.logic
{
   ...
   public class ObjectLogicBase implements IRoomObjectEventHandler
   {
      ...
      private var var_384:IRoomObjectController;
      ...
      {
         if(this.var_384 == param1)
         {
            return;
         }
         if(this.var_384 != null)
         {
            this.var_384.setEventHandler(null);
         }
         if(param1 == null)
         {
            this.dispose();
         ...
         {
            this.var_384 = param1;
            this.var_384.setEventHandler(this);
         }
      }
      ...
      public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         if(param1 != null)
         {
            if(this.var_384 != null)
            {
               this.var_384.setLocation(param1.loc);
               this.var_384.setDirection(param1.dir);
            }
         }
      }
   }
