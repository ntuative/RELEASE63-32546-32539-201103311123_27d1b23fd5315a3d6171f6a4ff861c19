package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1523:int = 10000;
      ...
      private var var_1110:IEncryption;
      
      private var var_735:IProtocol;
      
      private var _id:String;
      
      private var var_1109:IMessageClassManager;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this.var_1109 = new MessageClassManager();
         this.var_80 = new Socket();
         this.var_350 = new Timer(const_1523,1);
         this.var_350.addEventListener(TimerEvent.TIMER,this.onTimeOutTimer);
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_1109.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
            this.logConnection("Could not find registered message composer for " + param1);
            return false;
         }
         var _loc5_:ByteArray = this.var_735.encoder.encode(_loc4_,param1.getMessageArray(),param2);
         if(this.var_502)
         {
            this.var_502.messageSent(String(_loc4_),_loc5_.toString());
         }
         if(this.var_1110 != null)
         {
            _loc3_ = this.var_1110.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      {
         this.var_1109.registerMessages(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         _loc1_ += "Protocol Encoder: " + this.var_735.encoder + "\n";
         _loc1_ += "Protocol Decoder: " + this.var_735.method_6 + "\n";
         return _loc1_ + ("Encryption: " + this.var_1110 + "\n");
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_735.getMessages(this.var_501,receivedMessages);
         try
         {
            for each(message in receivedMessages)
            {
               ...
               eventClasses = this.var_1109.getMessageEventClasses(id);
               events = new Array();
               ...
               for each(messageEventInstance in events)
               {
                  ...
                  if(parserClass != null)
                  {
                     ...
                     if(parserClass != parserClassCurrent)
                     {
                        ...
                        dataWrapper = new MessageDataWrapper(dataClone,this.protocol.method_6);
      ...
      private function onConnect(param1:Event) : void
      {
         ...
         this.var_350.stop();
         this.var_1696 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - this.var_736));
      ...
      private function onClose(param1:Event) : void
      {
         ...
         this.var_1696 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - this.var_736));
         dispatchEvent(param1);
      }
      ...
      private function onComplete(param1:Event) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - this.var_736));
         dispatchEvent(param1);
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - this.var_736));
         dispatchEvent(param1);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - this.var_736));
         switch(param1.type)
         {
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - this.var_736));
         var _loc2_:IOErrorEvent = new IOErrorEvent(IOErrorEvent.IO_ERROR);
         _loc2_.text = "Socket Timeout (" + this.var_350.delay + " ms). Possible Firewall.";
