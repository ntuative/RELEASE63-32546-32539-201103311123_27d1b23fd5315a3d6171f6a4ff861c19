package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1758:uint = 1;
      
      protected static const const_1757:uint = 2;
      
      protected static const const_1755:uint = 4;
      
      protected static const const_1756:uint = 3;
      
      protected static const name_4:uint = 7;
      
      public static const const_1720:int = 5;
      
      public static const LIBRARY_LOADER_FINALIZE:String = "LIBRARY_LOADER_FINALIZE";
      
      public static const const_1076:Boolean = false;
      
      public static const const_1726:int = 2;
      
      private static var var_929:Array = new Array();
      
      private static var var_751:Array = new Array();
      ...
      protected var var_404:int = 0;
      
      protected var var_239:URLRequest;
      
      protected var _manifest:XML;
      
      protected var var_575:Class;
      
      protected var var_473:uint = 0;
      
      protected var _name:String;
      
      protected var var_1054:Boolean = false;
      
      protected var _debug:Boolean = false;
      
      protected var var_1055:Boolean = false;
      
      protected var var_2861:String = "";
      
      protected var var_2860:String = "";
      
      protected var var_2090:int;
      
      protected var var_1307:int;
      
      protected var var_1308:int;
      
      protected var var_2947:uint = 0;
      
      protected var var_2859:Boolean = true;
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1076)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_751[_loc2_] as LibraryLoader;
               if(_loc1_ && (_loc1_.ready || _loc1_.disposed))
               {
                  var_751.splice(_loc2_,1);
               }
               _loc2_--;
            }
            while(var_751.length < const_1726 && false)
            {
               _loc1_ = var_929.shift() as LibraryLoader;
      ...
      {
         return !!this.var_1054 ? uint(this.var_1307 - this.var_2090) : uint(getTimer() - this.var_2090);
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_DISPOSE,this.var_404,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
            try
            {
               this.var_42.close();
            }
      ...
      {
         if(this.var_1055 && !_disposed)
         {
            this.var_1055 = false;
            if(!this.var_1054 && this.var_239)
            {
               this.var_1307 = -1;
      ...
      {
         if(!this.var_1054 && !_disposed && this.var_1308 > 0)
         {
            try
            {
               this.var_42.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_239,const_1720 - this.var_1308);
            if(this.var_2859)
            {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HTTPStatusEvent.HTTP_STATUS:
               this.var_404 = HTTPStatusEvent(param1).status;
               this.debug("Load event STATUS " + this.var_404 + " for file \"" + this.url + "\"");
               break;
            case Event.UNLOAD:
               this.debug("Load event UNLOAD for file \"" + this.url + "\"");
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_UNLOAD,this.var_404,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
               break;
            case ProgressEvent.PROGRESS:
               this.debug("Load event PROGRESS for file \"" + this.url + "\"  bytes: " + this.bytesLoaded + "/" + this.bytesTotal);
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_PROGRESS,this.var_404,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
               break;
            case IOErrorEvent.IO_ERROR:
               this.debug("Load event IO ERROR for file \"" + this.url + "\"");
               if(!this.handleHttpStatus(this.var_404))
               {
                  this.var_1307 = getTimer();
            ...
            case TimerEvent.TIMER:
               ...
               if(!_disposed)
               {
                  this.var_473 = LibraryLoader.name_4;
         ...
         if(this.var_473 == LibraryLoader.const_1756)
         {
         ...
         if(this.var_473 == LibraryLoader.name_4)
         {
            if(this.prepareLibrary())
            {
               ...
               this.removeEventListeners();
               throttle();
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE,this.var_404,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         this.var_575 = this.getDefinition(this._name) as Class;
         ...
         try
         {
            xmlClass = this.var_575.manifest as Class;
            if(xmlClass == null)
            {
               return false;
            }
      ...
      protected function debug(param1:String) : void
      {
         ...
         if(this._debug)
         {
            dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_DEBUG,this.var_404,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
         }
      }
      ...
      protected function failure(param1:String) : void
      {
         ...
         throttle();
         dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR,this.var_404,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
         dispatchEvent(new Event(LIBRARY_LOADER_FINALIZE));
      }
