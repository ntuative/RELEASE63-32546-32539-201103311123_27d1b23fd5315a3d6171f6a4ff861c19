package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      protected static const const_423:String = "_INTERNAL_EVENT_UNLOCKED";
      ...
      public static const const_1085:uint = 4;
       
      
      protected var var_821:uint = 0;
      
      protected var var_1313:String = "";
      
      protected var var_2105:String = "";
      ...
      protected final function unlock() : void
      {
         ...
         {
            this.var_1030 = false;
            this._events.dispatchEvent(new LockEvent(const_423,this));
         }
      }
      
      public function toString() : String
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + this.var_821 + "]";
      }
