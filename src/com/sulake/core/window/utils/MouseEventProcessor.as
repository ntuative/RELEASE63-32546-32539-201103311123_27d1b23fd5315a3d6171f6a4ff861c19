package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected var var_178:WindowController;
      
      protected var var_74:WindowController;
      
      protected var var_159:IWindowRenderer;
      
      protected var var_150:IDesktopWindow;
      
      protected var var_861:IWindowContextStateListener;
      ...
      public function MouseEventProcessor()
      {
         ...
         {
            var_336 = new Array();
            var_336[0] = MouseCursorType.const_282;
            var_336[1] = MouseCursorType.const_32;
            var_336[2] = MouseCursorType.const_282;
            var_336[3] = MouseCursorType.const_282;
            var_336[4] = MouseCursorType.const_282;
            var_336[5] = MouseCursorType.const_32;
            var_336[6] = MouseCursorType.const_282;
         }
         if(var_288 == null)
         {
            var_288 = new Array();
            var_288[0] = WindowState.const_103;
            var_288[1] = WindowState.const_83;
            var_288[2] = WindowState.const_99;
            var_288[3] = WindowState.const_66;
            var_288[4] = WindowState.const_57;
            var_288[5] = WindowState.const_97;
            var_288[6] = WindowState.const_82;
         }
      }
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_74 = state.var_1302 as WindowController;
         this.var_178 = state.var_1300 as WindowController;
         this.var_159 = state.renderer;
         this.var_861 = state.var_1301;
         eventQueue.begin();
         this.var_694.x = -1;
         this.var_694.y = -1;
         ...
         while(true)
         {
            ...
            if(event.stageX != this.var_694.x || event.stageY != this.var_694.y)
            {
               ...
               array = new Array();
               this.var_150.groupParameterFilteredChildrenUnderPoint(this.var_694,array,WindowParam.const_30);
            }
            ...
            if(index == 0)
            {
               ...
               {
                  if(this.var_74 != this.var_150 && !this.var_74.disposed)
                  {
                     ...
                     this.var_74 = WindowController(this.var_150);
                  }
               }
               ...
               if(child != null && child.visible)
               {
                  ...
                  else if(event.type == MouseEvent.MOUSE_UP || event.type == MouseEvent.CLICK)
                  {
                     if(this.var_74 && !this.var_74.disposed)
                     {
                        ...
                        {
                           this.var_861.mouseEventReceived(event.type,this.var_74);
                        }
                     }
                  }
                  temp = child.parent;
         ...
         state.var_1302 = this.var_74;
         state.var_1300 = this.var_178;
         state.renderer = this.var_159;
         state.var_1301 = this.var_861;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         if(param2.type == MouseEvent.MOUSE_UP)
         {
            ...
            {
               if(this.var_178 && !this.var_178.disposed)
               {
                  this.var_178.update(this.var_178,convertMouseEventType(new MouseEvent(MouseEvent.MOUSE_UP,false,true,param2.localX,param2.localY,null,param2.ctrlKey,param2.altKey,param2.shiftKey,param2.buttonDown,param2.delta),this.var_178,param1));
                  this.var_178 = null;
               }
            }
         }
         var _loc5_:BitmapData = this.var_159.getDrawBufferForRenderable(param1);
