package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_185:String = "regular";
      ...
      private static var var_538:Array;
      
      private static var _eventDispatcher:IEventDispatcher;
      
      private static const const_630:String = "{";
      
      private static const const_629:String = "}";
      
      private static const const_1422:String = "/*";
      
      private static const const_1421:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_87[const_185],var_87[ITALIC],var_87[BOLD]];
            var_87.reset();
            var_87[const_185] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_538.indexOf(_loc4_.name) == -1)
            {
               var_538.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      public static function parseCSS(param1:String) : Array
      {
         ...
         for each(_loc7_ in _loc3_)
         {
            ...
            _loc6_.kerning = !!_loc5_.kerning ? _loc5_.kerning == "com.sulake.room.object.logic" : null;
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_629);
         if(countSubStrings(param1,const_630) != countSubStrings(param1,const_629))
         {
            throw new Error("Mismatching amount of \"" + const_630 + "\" versus \"" + const_629 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1422) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1421) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_630)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
