package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_856:Dictionary;
      
      protected var var_855:Dictionary;
      
      private var var_896:Matrix;
      
      public function BitmapSkinRenderer(param1:String)
      {
         super(param1);
         this.var_856 = new Dictionary(false);
         this.var_855 = new Dictionary(false);
         this.var_896 = new Matrix();
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            super.dispose();
            this.var_896 = null;
            for(_loc1_ in this.var_856)
            {
               _loc2_ = this.var_856[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_856[_loc1_];
            }
            this.var_856 = null;
            for(_loc1_ in this.var_855)
            {
               _loc2_ = this.var_855[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_855[_loc1_];
            }
            this.var_855 = null;
         }
      }
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            while(_loc16_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc10_.scaleH == SkinLayoutEntity.const_304)
                  {
                     var_34.x += _loc14_;
                  }
                  else if(_loc10_.scaleH == SkinLayoutEntity.const_481)
                  {
                     _loc12_ = true;
                  ...
                  else if(_loc10_.scaleH == SkinLayoutEntity.const_313)
                  {
                     _loc12_ = true;
                     var_34.right += _loc14_;
                     if(true)
                  ...
                  if(_loc10_.scaleV == SkinLayoutEntity.const_304)
                  {
                     var_34.y += _loc15_;
                  }
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_481)
                  {
                     _loc13_ = true;
                  ...
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_313)
                  {
                     _loc13_ = true;
                     var_34.bottom += _loc15_;
                     if(true)
                  ...
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_313 || _loc10_.scaleH == SkinLayoutEntity.const_313)
                  {
                  ...
                  {
                     this.var_896.a = 0 / _loc17_.width;
                     this.var_896.d = 0 / _loc17_.height;
                     _loc30_ = new BitmapData(var_34.width,var_34.height,false);
                     _loc30_.draw(_loc17_,this.var_896);
                     _loc31_ = new BitmapData(var_34.width,var_34.height,true,0);
                     _loc31_.draw(_loc18_,this.var_896,null);
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:ISkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.scaleH == SkinLayoutEntity.const_304)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.scaleV == SkinLayoutEntity.const_304)
               {
      ...
      private function getBitmapFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc4_:BitmapData = this.var_856[_loc3_];
         if(_loc4_ == null)
         {
      ...
      private function getAlphaFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc6_:* = null;
         var _loc3_:String = param2 + "@" + param1.name;
         var _loc4_:BitmapData = this.var_855[_loc3_];
         if(_loc4_ == null)
         {
            _loc5_ = param1.getChildByName(param2) as ISkinTemplateEntity;
            if(_loc5_ == null)
