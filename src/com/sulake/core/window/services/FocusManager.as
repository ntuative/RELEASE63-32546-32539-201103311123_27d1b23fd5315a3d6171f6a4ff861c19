package com.sulake.core.window.services
{
   ...
   public class FocusManager extends ChildEntityArrayReader implements IFocusManagerService
   {
      ...
      private var var_135:Stage;
      
      public function FocusManager(param1:DisplayObject)
      {
         this.var_135 = param1.stage;
         this.var_135.addEventListener(Event.ACTIVATE,this.onActivateEvent);
         this.var_135.addEventListener(FocusEvent.FOCUS_OUT,this.onFocusEvent);
         this.var_135.addEventListener(FocusEvent.KEY_FOCUS_CHANGE,this.onFocusEvent);
         this.var_135.addEventListener(FocusEvent.MOUSE_FOCUS_CHANGE,this.onFocusEvent);
         super();
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            this.var_135.removeEventListener(Event.ACTIVATE,this.onActivateEvent);
            this.var_135.removeEventListener(FocusEvent.FOCUS_OUT,this.onFocusEvent);
            this.var_135.removeEventListener(FocusEvent.KEY_FOCUS_CHANGE,this.onFocusEvent);
            this.var_135.removeEventListener(FocusEvent.MOUSE_FOCUS_CHANGE,this.onFocusEvent);
            this.var_135 = null;
            this._disposed = true;
            var_32 = null;
         }
