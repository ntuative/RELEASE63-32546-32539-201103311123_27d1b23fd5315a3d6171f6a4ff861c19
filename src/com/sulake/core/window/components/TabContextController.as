package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1311:String = "_CONTENT";
       
      
      protected var var_1050:ITabSelectorWindow;
      
      protected var var_2087:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1050 = findChildByTag(const_1312) as ITabSelectorWindow;
            if(this.var_1050 != null)
            {
               this.var_1050.procedure = this.selectorEventProc;
            }
         }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2087 = findChildByTag(const_1311) as IWindowContainer;
         }
      ...
      {
         return this.var_1050.numSelectables;
      }
