package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1572:uint = 500;
      
      protected var var_1309:String = "";
      
      protected var var_1304:Boolean = false;
      
      protected var var_788:Boolean = false;
      ...
      {
         this.var_1309 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_21)
         {
            var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1100,var_11);
         }
         return var_21;
      }
      ...
      {
         if(param1.type == WindowTouchEvent.const_489)
         {
            this.focus();
         }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_788 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            _context.handleError(WindowContext.const_355,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_670,false,PropertyStruct.const_37,true) : PropertyDefaults.const_1565);
         _loc1_.push(this.var_1304 != PropertyDefaults.const_1129 ? new PropertyStruct(PropertyDefaults.const_674,this.var_1304,PropertyStruct.const_37,true) : PropertyDefaults.const_1709);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1154 ? new PropertyStruct(PropertyDefaults.const_745,_field.selectable,PropertyStruct.const_37,true) : PropertyDefaults.const_1722);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1253 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_37,true) : PropertyDefaults.const_1657);
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_674:
                  this.var_1304 = _loc2_.value as Boolean;
                  if(this.var_1304)
                  {
               ...
               case PropertyDefaults.const_745:
                  ...
                  break;
               case PropertyDefaults.const_670:
                  _field.type = !!_loc2_.value ? "null" : TextFieldType.DYNAMIC;
                  break;
               case PropertyDefaults.const_1119:
