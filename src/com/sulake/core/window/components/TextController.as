package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1272:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_860:Number;
      ...
      protected var var_128:Boolean = false;
      
      protected var var_1060:Boolean = false;
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_463,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_463 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_463,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_185);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_697 ? true : null;
         }
      ...
      {
         this.var_860 = param1;
         this._field.scrollH = this.var_860 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_860 * this.maxScrollH,this.var_567 * this.maxScrollV,width,height);
      }
      ...
      protected function immediateClickHandler(param1:Event) : void
      {
         ...
         var _loc4_:WindowEvent = new WindowMouseEvent(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this,null,_loc3_.x,_loc3_.y,_loc2_.stageX,_loc2_.stageY,_loc2_.altKey,_loc2_.ctrlKey,_loc2_.shiftKey,_loc2_.buttonDown,_loc2_.delta,false);
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.antiAliasType != null ? this._field.antiAliasType != _loc2_.antiAliasType : this._field.antiAliasType != PropertyDefaults.const_1072) ? new PropertyStruct(PropertyDefaults.const_683,this._field.antiAliasType,PropertyStruct.const_55,this._field.antiAliasType != AntiAliasType.NORMAL,PropertyDefaults.const_1111) : PropertyDefaults.const_1570);
         _loc1_.push(this._autoSize != PropertyDefaults.const_1116 ? new PropertyStruct(PropertyDefaults.const_725,this._autoSize,PropertyStruct.const_55,true,PropertyDefaults.const_1204) : PropertyDefaults.const_1563);
         ...
         _loc1_.push(new PropertyStruct("font_face",this.defaultTextFormat.font,PropertyStruct.const_55,this.defaultTextFormat.font != _loc2_.fontFamily));
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_254,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1232 ? new PropertyStruct(PropertyDefaults.const_1071,this._field.gridFitType,PropertyStruct.const_55,true,PropertyDefaults.const_1066) : PropertyDefaults.const_1743);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_720) ? new PropertyStruct(PropertyDefaults.const_380,this._field.textColor,PropertyStruct.const_128,true) : PropertyDefaults.const_1241);
         ...
         _loc1_.push(this.var_39.left != PropertyDefaults.const_736 ? new PropertyStruct(PropertyDefaults.const_224,this.var_39.left,PropertyStruct.const_42,true) : PropertyDefaults.const_455);
         _loc1_.push(this.var_39.top != PropertyDefaults.const_857 ? new PropertyStruct(PropertyDefaults.const_264,this.var_39.top,PropertyStruct.const_42,true) : PropertyDefaults.const_583);
         _loc1_.push(this.var_39.right != PropertyDefaults.const_869 ? new PropertyStruct(PropertyDefaults.const_247,this.var_39.right,PropertyStruct.const_42,true) : PropertyDefaults.const_547);
         _loc1_.push(this.var_39.bottom != PropertyDefaults.const_800 ? new PropertyStruct(PropertyDefaults.const_257,this.var_39.bottom,PropertyStruct.const_42,true) : PropertyDefaults.const_501);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1063 ? new PropertyStruct(PropertyDefaults.const_818,this._field.mouseWheelEnabled,PropertyStruct.const_37,true) : PropertyDefaults.const_1554);
         ...
         _loc1_.push(new PropertyStruct("restrict",this._field.restrict,PropertyStruct.const_55,this._field.restrict != null));
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_245,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_245,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_245,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
