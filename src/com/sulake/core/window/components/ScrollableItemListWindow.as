package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      override public function dispose() : void
      {
         if(this.var_435)
         {
            this.var_435.removeEventListener(WindowEvent.const_325,this.scrollBarEventProc);
            this.var_435.removeEventListener(WindowEvent.const_239,this.scrollBarEventProc);
            this.var_435 = null;
         }
         if(this.var_1136)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1136)
         {
            this.var_1136 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_435)
         {
            ...
            if(this.var_435)
            {
               this.var_435.addEventListener(WindowEvent.const_325,this.scrollBarEventProc);
               this.var_435.addEventListener(WindowEvent.const_239,this.scrollBarEventProc);
            }
         }
         return this.var_435;
      }
      ...
      {
         if(param1.type == WindowEvent.const_325)
         {
            this.showScrollBar();
         }
         else if(param1.type == WindowEvent.const_239)
         {
            this.hideScrollBar();
         }
      }
