package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_961:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_960:String = "default";
      
      private var var_1179:String = null;
      
      private var var_1817:StyleSheet = null;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1179 == param2)
         {
            return;
         }
         param1.var_1179 = param2;
         param1.var_1817 = null;
         if(param1.var_1179 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1179);
            param1.var_1817 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_641.indexOf(param1) > -1)
         {
            this.var_960 = param1;
         }
      }
      ...
      {
         return this.var_960 == LinkTarget.const_32 ? defaultLinkTarget : this.var_960;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_19);
            _field.styleSheet = this.var_1817;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_852)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_960 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_870,this.var_960,PropertyStruct.const_55,true,PropertyDefaults.const_641));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1595);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_870)
            {
               this.var_960 = _loc2_.value as String;
               break;
            }
