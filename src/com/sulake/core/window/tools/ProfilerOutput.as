package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private var var_172:IProfiler;
      
      private var var_23:ICore;
      
      private var _window:IFrameWindow;
      
      private var var_2910:Array;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         this.var_2910 = new Array();
         this.var_172 = this.profiler;
      ...
      public function set profiler(param1:IProfiler) : void
      {
         if(this.var_172)
         {
            this.var_172.removeStopEventListener(this.refresh);
            this.var_172 = null;
         }
         if(!this.var_172 && param1)
         {
            this.var_172 = param1;
            this.var_172.addStopEventListener(this.refresh);
         }
      }
      ...
      private function profilerWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param2.name == "footer_enable_toggle")
         {
            ...
            else if(param1.type == WindowEvent.const_758)
            {
               this.var_1984 = false;
               ILabelWindow(this._window.findChildByName("footer")).textColor = 4284900966;
            }
      ...
      {
         var _loc2_:Array = this.var_172.getProfilerAgentsInArray();
         ...
         if(this.var_1984)
         {
            this._window.findChildByName("footer").caption = "Assets - Libraries: " + this.var_172.numAssetLibraryInstances + " " + "Bitmaps: " + this.var_172.numBitmapAssetInstances + " / " + this.var_172.numAllocatedBitmapDataBytes + " bytes \n" + "Windows - Allocated bitmap data: " + (this.var_919.allocatedByteCount + GraphicContext.allocatedByteCount) + " bytes \n" + "Tracked bitmap data: " + this.var_172.numTrackedBitmapDataInstances + " / " + this.var_172.numTrackedBitmapDataBytes + " bytes";
         }
      }
